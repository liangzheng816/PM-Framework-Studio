...
slug: innovation-portfolio-balance
aliases: []
category: systems-thinking
categoryLabel: Systems thinking
summary: >-
  Innovation Portfolio Balance is a **systems thinking** framework used to
  understand the broader structure around the product, including dependencies,
  incentives, constraints, and feedback loops.
best_for: []
stage:
  - strategy
  - planning
