...
slug: feature-priority-pyramid
aliases: []
category: execution
categoryLabel: Execution
summary: >-
  Feature Priority Pyramid is a **execution** framework used to translate intent
  into scope, sequence, ownership, and repeatable delivery decisions.
best_for: []
stage:
  - execution
  - delivery
