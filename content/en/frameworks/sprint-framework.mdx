...
slug: sprint-framework
aliases: []
category: execution
categoryLabel: Execution
summary: >-
  Sprint Framework is a **execution** framework used to translate intent into
  scope, sequence, ownership, and repeatable delivery decisions.
best_for: []
stage:
  - execution
  - delivery
