...
summary: >-
  5 Whys is a **problem framing** framework used to separate the real problem
  from noise, symptoms, assumptions, and premature solution ideas.
best_for: []
stage:
  - discovery
  - definition
...
confidence: high
canonical_status: Canonical root-cause technique.
order: 14
---
...
5 Whys is a **problem framing** framework used to separate the real problem from noise, symptoms, assumptions, and premature solution ideas. In the uploaded PMFrame workbook, it is described as: **Repeatedly asks why a problem happened until the team reaches a root cause. Best for incident review or operational troubleshooting when symptoms keep recurring.**. In practical product work, its value is that it gives teams a repeatable way to move from ambiguity to a clearer decision, artifact, or next experiment without pretending there is more certainty than the evidence actually supports.
...
5 Whys helps by imposing a **useful frame** on the work. It is especially helpful when you need to incident review or operational troubleshooting when symptoms keep recurring. The method is less helpful when the real problem is already well evidenced and the team simply needs execution discipline.

## Canonical origin and what is “official” here

- **Origin / lineage:** Associated with Toyota Production System and Taiichi Ohno.
- **Canonical status:** Canonical root-cause technique.
...
### Canonical structure
1. **Problem statement** — Use this part to move the team from raw input toward a decision or artifact.
2. **First why** — Use this part to move the team from raw input toward a decision or artifact.
3. **Deeper whys** — Use this part to move the team from raw input toward a decision or artifact.
4. **Root cause hypothesis** — Use this part to move the team from raw input toward a decision or artifact.
5. **Corrective action** — Use this part to move the team from raw input toward a decision or artifact.
...
- **Primary fit:** incident review or operational troubleshooting when symptoms keep recurring
- **Secondary fit:** situations where you need to align multiple people around the same lens before committing time or budget.
- **Good complement to:** Musk’s Five-Step Method, HMW Problem Frame.
...
**Practical caution:** This framework is strongest when used to incident review or operational troubleshooting when symptoms keep recurring
...
5 Whys is most useful when you need a **disciplined lens** for a specific kind of product problem—not as a universal answer, but as a way to improve the quality of thinking, collaboration, and decision-making around that problem.
