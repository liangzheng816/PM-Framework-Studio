...
summary: >-
  STP is a **growth** framework used to identify where demand, retention,
...
companion_frameworks:
  - network-effects
confidence: high
canonical_status: Canonical marketing framework.
order: 83
---
...
STP is a **growth** framework used to identify where demand, retention, messaging, or economics can improve compounding growth. In the uploaded PMFrame workbook, it is described as: **Segments a market, selects target segments, and positions an offer. Best for clarifying who to pursue and how to differentiate.**. In practical product work, its value is that it gives teams a repeatable way to move from ambiguity to a clearer decision, artifact, or next experiment without pretending there is more certainty than the evidence actually supports.
...
STP helps by imposing a **useful frame** on the work. It is especially helpful when you need to clarifying who to pursue and how to differentiate. The method is less helpful when the product still lacks a credible core value proposition or reliable retention signal.

## Canonical origin and what is “official” here

- **Origin / lineage:** Classic marketing strategy literature.
- **Canonical status:** Canonical marketing framework.
...
### Canonical structure
1. **Segmentation** — Use this part to move the team from raw input toward a decision or artifact.
2. **Targeting** — Use this part to move the team from raw input toward a decision or artifact.
3. **Positioning** — Use this part to move the team from raw input toward a decision or artifact.
...
**Practical caution:** This framework is strongest when used to clarifying who to pursue and how to differentiate
...
STP is most useful when you need a **disciplined lens** for a specific kind of product problem—not as a universal answer, but as a way to improve the quality of thinking, collaboration, and decision-making around that problem.
