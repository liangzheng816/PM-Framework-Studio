...
slug: competitive-positioning-map
aliases: []
category: growth
categoryLabel: Growth
summary: >-
  Competitive Positioning Map is a **growth** framework used to identify where
  demand, retention, messaging, or economics can improve compounding growth.
best_for: []
stage:
  - growth
  - scaling
