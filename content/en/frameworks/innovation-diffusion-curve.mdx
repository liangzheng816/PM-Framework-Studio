...
slug: innovation-diffusion-curve
aliases: []
category: ideation
categoryLabel: Ideation
summary: >-
  Innovation Diffusion Curve is a **ideation** framework used to expand the
  option space before the team commits too early to one direction.
best_for: []
stage:
  - ideation
  - concept
