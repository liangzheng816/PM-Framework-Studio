---
title: "Idea Feasibility Threshold"
category: "Validation"
pmframe_order: 054
language: "English"
confidence: "Moderate"
canonical_status: "Practitioner screening method; no single canonical source."
---
...
Idea Feasibility Threshold is a **validation** framework used to reduce uncertainty by turning product beliefs into tests, metrics, and evidence-backed decisions. In the uploaded PMFrame workbook, it is described as: **Defines the minimum bar an idea must clear before it earns more resources. Best for filtering inflated ideation pipelines.**. In practical product work, its value is that it gives teams a repeatable way to move from ambiguity to a clearer decision, artifact, or next experiment without pretending there is more certainty than the evidence actually supports.
...
Idea Feasibility Threshold helps by imposing a **useful frame** on the work. It is especially helpful when you need to filtering inflated ideation pipelines. The method is less helpful when there is no meaningful hypothesis yet or no decision will change based on the evidence.

## Canonical origin and what is “official” here

- **Origin / lineage:** A simple gating concept used to stop weak ideas before deeper investment.
- **Canonical status:** Practitioner screening method; no single canonical source.
...
1. **User value minimum** — Use this part to move the team from raw input toward a decision or artifact.
2. **Feasibility minimum** — Use this part to move the team from raw input toward a decision or artifact.
3. **Business viability minimum** — Use this part to move the team from raw input toward a decision or artifact.
4. **Risk threshold** — Use this part to move the team from raw input toward a decision or artifact.
5. **Go / no-go** — Use this part to move the team from raw input toward a decision or artifact.

## When to use it

Use Idea Feasibility Threshold when:
...
**Practical caution:** This framework is strongest when used to filtering inflated ideation pipelines
...
- **HEART Framework** — Adjacent method in the same PMFrame cluster.
- **PURE Usability Evaluation** — Adjacent method in the same PMFrame cluster.

## References and authority trail

The note was grounded in the following authority sources or canonical references:
- Innovation portfolio gating practice
- Product stage-gate methods
- PMFrame.works research workbook (uploaded source list)

## Bottom line

Idea Feasibility Threshold is most useful when you need a **disciplined lens** for a specific kind of product problem—not as a universal answer, but as a way to improve the quality of thinking, collaboration, and decision-making around that problem.
