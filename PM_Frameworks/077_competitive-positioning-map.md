...
language: "English"
confidence: "Moderate"
canonical_status: "Established strategy visualization; exact templates vary."
---
...
Competitive Positioning Map is a **growth** framework used to identify where demand, retention, messaging, or economics can improve compounding growth. In the uploaded PMFrame workbook, it is described as: **Plots your offer against competitors on the dimensions users care about most. Best for finding whitespace and sharpening messaging.**. In practical product work, its value is that it gives teams a repeatable way to move from ambiguity to a clearer decision, artifact, or next experiment without pretending there is more certainty than the evidence actually supports.
...
Competitive Positioning Map helps by imposing a **useful frame** on the work. It is especially helpful when you need to finding whitespace and sharpening messaging. The method is less helpful when the product still lacks a credible core value proposition or reliable retention signal.

## Canonical origin and what is “official” here

- **Origin / lineage:** Product marketing and strategy practice.
- **Canonical status:** Established strategy visualization; exact templates vary.
...
1. **Axes users care about** — Use this part to move the team from raw input toward a decision or artifact.
2. **Competitor positions** — Use this part to move the team from raw input toward a decision or artifact.
3. **White space** — Use this part to move the team from raw input toward a decision or artifact.
4. **Implication for positioning** — Use this part to move the team from raw input toward a decision or artifact.

## When to use it

Use Competitive Positioning Map when:
...
**Practical caution:** This framework is strongest when used to finding whitespace and sharpening messaging

## Related frameworks

- **Hook Model** — Adjacent method in the same PMFrame cluster.
- **PMF** — Adjacent method in the same PMFrame cluster.
...
- Competitive mapping methods
- PMFrame.works research workbook (uploaded source list)

## Bottom line

Competitive Positioning Map is most useful when you need a **disciplined lens** for a specific kind of product problem—not as a universal answer, but as a way to improve the quality of thinking, collaboration, and decision-making around that problem.
