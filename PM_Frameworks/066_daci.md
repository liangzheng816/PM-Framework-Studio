...
language: "English"
confidence: "Moderate"
canonical_status: "Established decision-rights framework."
---
...
DACI is a **execution** framework used to translate intent into scope, sequence, ownership, and repeatable delivery decisions. In the uploaded PMFrame workbook, it is described as: **Clarifies driver, approver, contributors, and informed stakeholders. Best for reducing decision ambiguity and meeting thrash.**. In practical product work, its value is that it gives teams a repeatable way to move from ambiguity to a clearer decision, artifact, or next experiment without pretending there is more certainty than the evidence actually supports.
...
DACI helps by imposing a **useful frame** on the work. It is especially helpful when you need to reducing decision ambiguity and meeting thrash. The method is less helpful when the team is still unclear about the user problem or the evidence base behind the work.

## Canonical origin and what is “official” here

- **Origin / lineage:** Often associated with Intuit and corporate decision-making practice.
- **Canonical status:** Established decision-rights framework.
...
1. **Driver** — Use this part to move the team from raw input toward a decision or artifact.
2. **Approver** — Use this part to move the team from raw input toward a decision or artifact.
3. **Contributors** — Use this part to move the team from raw input toward a decision or artifact.
4. **Informed** — Use this part to move the team from raw input toward a decision or artifact.
...
**Practical caution:** This framework is strongest when used to reducing decision ambiguity and meeting thrash

## Related frameworks

- **Shape Up** — Adjacent method in the same PMFrame cluster.
- **Now–Next–Later** — Adjacent method in the same PMFrame cluster.
- **ICE Scoring** — Adjacent method in the same PMFrame cluster.
...
DACI is most useful when you need a **disciplined lens** for a specific kind of product problem—not as a universal answer, but as a way to improve the quality of thinking, collaboration, and decision-making around that problem.
