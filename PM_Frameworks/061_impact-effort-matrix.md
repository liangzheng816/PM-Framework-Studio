...
language: "English"
confidence: "Moderate"
canonical_status: "Common prioritization tool; many variants exist."
---
...
Impact–Effort Matrix helps by imposing a **useful frame** on the work. It is especially helpful when you need to rough-cut prioritization. The method is less helpful when the team is still unclear about the user problem or the evidence base behind the work.

## Canonical origin and what is “official” here

- **Origin / lineage:** Facilitation and portfolio prioritization practice.
- **Canonical status:** Common prioritization tool; many variants exist.
...
1. **High impact / low effort** — Use this part to move the team from raw input toward a decision or artifact.
2. **High impact / high effort** — Use this part to move the team from raw input toward a decision or artifact.
3. **Low impact / low effort** — Use this part to move the team from raw input toward a decision or artifact.
4. **Low impact / high effort** — Use this part to move the team from raw input toward a decision or artifact.

## When to use it

Use Impact–Effort Matrix when:
...
- **Primary fit:** rough-cut prioritization
...
**Practical caution:** This framework is strongest when used to rough-cut prioritization
...
Impact–Effort Matrix is most useful when you need a **disciplined lens** for a specific kind of product problem—not as a universal answer, but as a way to improve the quality of thinking, collaboration, and decision-making around that problem.
