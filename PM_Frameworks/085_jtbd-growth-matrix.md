---
title: "JTBD Growth Matrix"
category: "Growth"
pmframe_order: 085
language: "English"
confidence: "Moderate"
canonical_status: "Practitioner synthesis, not a single canonical academic matrix."
---
...
JTBD Growth Matrix helps by imposing a **useful frame** on the work. It is especially helpful when you need to pinpointing where growth opportunities are most compelling. The method is less helpful when the product still lacks a credible core value proposition or reliable retention signal.

## Canonical origin and what is “official” here

- **Origin / lineage:** A job-based opportunity mapping method combining importance and satisfaction to surface growth headroom.
- **Canonical status:** Practitioner synthesis, not a single canonical academic matrix.
...
1. **Jobs / outcomes** — Use this part to move the team from raw input toward a decision or artifact.
2. **Importance** — Use this part to move the team from raw input toward a decision or artifact.
3. **Satisfaction** — Use this part to move the team from raw input toward a decision or artifact.
4. **Underserved segments** — Use this part to move the team from raw input toward a decision or artifact.
5. **Growth bets** — Use this part to move the team from raw input toward a decision or artifact.

## When to use it

Use JTBD Growth Matrix when:
...
**Practical caution:** This framework is strongest when used to pinpointing where growth opportunities are most compelling

## Related frameworks

- **STP** — Adjacent method in the same PMFrame cluster.
- **Fogg Behavior Model** — Adjacent method in the same PMFrame cluster.
- **Four Actions Framework** — Adjacent method in the same PMFrame cluster.
...
- JTBD and ODI practice
- Opportunity mapping methods
- PMFrame.works research workbook (uploaded source list)

## Bottom line

JTBD Growth Matrix is most useful when you need a **disciplined lens** for a specific kind of product problem—not as a universal answer, but as a way to improve the quality of thinking, collaboration, and decision-making around that problem.
