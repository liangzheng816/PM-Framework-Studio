...
language: "English"
confidence: "High"
canonical_status: "Canonical Strategyzer tool."
---
...
Value Proposition Canvas is a **ideation** framework used to expand the option space before the team commits too early to one direction. In the uploaded PMFrame workbook, it is described as: **Matches customer jobs, pains, and gains to products, pain relievers, and gain creators. Best for clarifying why the offer matters and to whom.**. In practical product work, its value is that it gives teams a repeatable way to move from ambiguity to a clearer decision, artifact, or next experiment without pretending there is more certainty than the evidence actually supports.
...
Value Proposition Canvas helps by imposing a **useful frame** on the work. It is especially helpful when you need to clarifying why the offer matters and to whom. The method is less helpful when the main uncertainty is no longer idea quality but evidence, feasibility, or delivery.

## Canonical origin and what is “official” here

- **Origin / lineage:** Created by Alexander Osterwalder and Strategyzer.
- **Canonical status:** Canonical Strategyzer tool.
...
### Canonical structure
1. **Customer jobs** — Use this part to move the team from raw input toward a decision or artifact.
2. **Pains** — Use this part to move the team from raw input toward a decision or artifact.
3. **Gains** — Use this part to move the team from raw input toward a decision or artifact.
4. **Products and services** — Use this part to move the team from raw input toward a decision or artifact.
5. **Pain relievers** — Use this part to move the team from raw input toward a decision or artifact.
6. **Gain creators** — Use this part to move the team from raw input toward a decision or artifact.
...
**Practical caution:** Do not fill both sides equally; the customer profile should drive the map.

## Related frameworks

- **Crazy 8s** — Adjacent method in the same PMFrame cluster.
- **Analogical Thinking** — Adjacent method in the same PMFrame cluster.
- **How-Now-Wow Matrix** — Adjacent method in the same PMFrame cluster.
...
Value Proposition Canvas is most useful when you need a **disciplined lens** for a specific kind of product problem—not as a universal answer, but as a way to improve the quality of thinking, collaboration, and decision-making around that problem.
