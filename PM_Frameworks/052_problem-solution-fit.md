...
language: "English"
confidence: "High"
canonical_status: "Canonical early-stage validation concept."
---
...
Problem-Solution Fit is a **validation** framework used to reduce uncertainty by turning product beliefs into tests, metrics, and evidence-backed decisions. In the uploaded PMFrame workbook, it is described as: **Checks whether the problem is real, painful, and important—and whether the proposed solution actually addresses it. Best before chasing product-market fit.**. In practical product work, its value is that it gives teams a repeatable way to move from ambiguity to a clearer decision, artifact, or next experiment without pretending there is more certainty than the evidence actually supports.
...
Problem-Solution Fit helps by imposing a **useful frame** on the work. It is especially helpful when you need to high-risk assumptions, usability questions, product-market fit signals, and investment gates. The method is less helpful when there is no meaningful hypothesis yet or no decision will change based on the evidence.

## Canonical origin and what is “official” here

- **Origin / lineage:** Part of lean startup and product discovery practice.
- **Canonical status:** Canonical early-stage validation concept.
...
### Canonical structure
1. **Important problem** — Use this part to move the team from raw input toward a decision or artifact.
2. **Specific audience** — Use this part to move the team from raw input toward a decision or artifact.
3. **Current alternatives** — Use this part to move the team from raw input toward a decision or artifact.
4. **Proposed solution** — Use this part to move the team from raw input toward a decision or artifact.
5. **Evidence of resonance** — Use this part to move the team from raw input toward a decision or artifact.

## When to use it

Use Problem-Solution Fit when:
...
- **Primary fit:** high-risk assumptions, usability questions, product-market fit signals, and investment gates
- **Secondary fit:** situations where you need to align multiple people around the same lens before committing time or budget.
- **Good complement to:** Validation Learning Loop, Lean Canvas.
...
**Practical caution:** Use it as a decision aid, not as ritual.

## Related frameworks

- **Validation Learning Loop** — Adjacent method in the same PMFrame cluster.
- **Lean Canvas** — Adjacent method in the same PMFrame cluster.
- **Task Completion Rate Test** — Adjacent method in the same PMFrame cluster.
- **Idea Feasibility Threshold** — Adjacent method in the same PMFrame cluster.

## References and authority trail

The note was grounded in the following authority sources or canonical references:
- Lean startup / discovery practice
- Problem-solution fit literature
- PMFrame.works research workbook (uploaded source list)

## Bottom line

Problem-Solution Fit is most useful when you need a **disciplined lens** for a specific kind of product problem—not as a universal answer, but as a way to improve the quality of thinking, collaboration, and decision-making around that problem.
