...
language: "English"
confidence: "High"
canonical_status: "Canonical modern discovery artifact."
---
...
Opportunity Solution Tree is a **ideation** framework used to expand the option space before the team commits too early to one direction. In the uploaded PMFrame workbook, it is described as: **Links desired outcomes to opportunities and then to solution ideas and tests. Best for keeping experimentation tied to a measurable objective.**. In practical product work, its value is that it gives teams a repeatable way to move from ambiguity to a clearer decision, artifact, or next experiment without pretending there is more certainty than the evidence actually supports.
...
Opportunity Solution Tree helps by imposing a **useful frame** on the work. It is especially helpful when you need to keeping experimentation tied to a measurable objective. The method is less helpful when the main uncertainty is no longer idea quality but evidence, feasibility, or delivery.

## Canonical origin and what is “official” here

- **Origin / lineage:** Created by Teresa Torres.
- **Canonical status:** Canonical modern discovery artifact.
...
### Canonical structure
1. **Outcome** — Use this part to move the team from raw input toward a decision or artifact.
2. **Opportunities** — Use this part to move the team from raw input toward a decision or artifact.
3. **Solutions** — Use this part to move the team from raw input toward a decision or artifact.
4. **Experiments** — Use this part to move the team from raw input toward a decision or artifact.
...
- **Primary fit:** keeping experimentation tied to a measurable objective
- **Secondary fit:** situations where you need to align multiple people around the same lens before committing time or budget.
- **Good complement to:** Value Proposition Canvas, How-Now-Wow Matrix.
...
**Practical caution:** The tree is most useful when the desired outcome is measurable and each branch can lead to a real test.
...
- Teresa Torres writings
- PMFrame.works research workbook (uploaded source list)

## Bottom line

Opportunity Solution Tree is most useful when you need a **disciplined lens** for a specific kind of product problem—not as a universal answer, but as a way to improve the quality of thinking, collaboration, and decision-making around that problem.
