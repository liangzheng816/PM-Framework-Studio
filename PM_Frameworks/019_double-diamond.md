...
language: "English"
confidence: "High"
canonical_status: "Canonical design process model."
---
...
Double Diamond is a **problem framing** framework used to separate the real problem from noise, symptoms, assumptions, and premature solution ideas. In the uploaded PMFrame workbook, it is described as: **Separates divergent/convergent work in both problem space and solution space. Best for teams that habitually jump from request to solution too early.**. In practical product work, its value is that it gives teams a repeatable way to move from ambiguity to a clearer decision, artifact, or next experiment without pretending there is more certainty than the evidence actually supports.
...
Double Diamond helps by imposing a **useful frame** on the work. It is especially helpful when you need to teams that habitually jump from request to solution too early. The method is less helpful when the real problem is already well evidenced and the team simply needs execution discipline.

## Canonical origin and what is “official” here

- **Origin / lineage:** Developed by the UK Design Council.
- **Canonical status:** Canonical design process model.
...
### Canonical structure
1. **Discover** — Use this part to move the team from raw input toward a decision or artifact.
2. **Define** — Use this part to move the team from raw input toward a decision or artifact.
3. **Develop** — Use this part to move the team from raw input toward a decision or artifact.
4. **Deliver** — Use this part to move the team from raw input toward a decision or artifact.
...
- **Primary fit:** teams that habitually jump from request to solution too early
- **Secondary fit:** situations where you need to align multiple people around the same lens before committing time or budget.
- **Good complement to:** Problem Tree, Iceberg Model.
...
**Practical caution:** Its main value is forcing divergence and convergence twice—first on the problem, then on the solution.

## Related frameworks

- **Problem Tree** — Adjacent method in the same PMFrame cluster.
- **Iceberg Model** — Adjacent method in the same PMFrame cluster.
...
- Design process literature
- PMFrame.works research workbook (uploaded source list)

## Bottom line

Double Diamond is most useful when you need a **disciplined lens** for a specific kind of product problem—not as a universal answer, but as a way to improve the quality of thinking, collaboration, and decision-making around that problem.
