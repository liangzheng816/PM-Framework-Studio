...
language: "English"
confidence: "High"
canonical_status: "Canonical creativity checklist."
---
...
SCAMPER helps by imposing a **useful frame** on the work. It is especially helpful when you need to concept generation, workshop facilitation, design exploration, and finding non-obvious options. The method is less helpful when the main uncertainty is no longer idea quality but evidence, feasibility, or delivery.

## Canonical origin and what is “official” here

- **Origin / lineage:** Popularized by Bob Eberle based on Alex Osborn’s ideation work.
- **Canonical status:** Canonical creativity checklist.
...
### Canonical structure
1. **Substitute** — Use this part to move the team from raw input toward a decision or artifact.
2. **Combine** — Use this part to move the team from raw input toward a decision or artifact.
3. **Adapt** — Use this part to move the team from raw input toward a decision or artifact.
4. **Modify** — Use this part to move the team from raw input toward a decision or artifact.
5. **Put to another use** — Use this part to move the team from raw input toward a decision or artifact.
6. **Eliminate** — Use this part to move the team from raw input toward a decision or artifact.
7. **Reverse** — Use this part to move the team from raw input toward a decision or artifact.
...
- **Good complement to:** Six Thinking Hats, Reverse Brainstorming.
...
- Bob Eberle SCAMPER
- Creative problem solving literature
- PMFrame.works research workbook (uploaded source list)

## Bottom line

SCAMPER is most useful when you need a **disciplined lens** for a specific kind of product problem—not as a universal answer, but as a way to improve the quality of thinking, collaboration, and decision-making around that problem.
