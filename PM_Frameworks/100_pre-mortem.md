...
language: "English"
confidence: "Moderate"
canonical_status: "Established risk-anticipation technique."
---
...
Pre-mortem helps by imposing a **useful frame** on the work. It is especially helpful when you need to large bets, launches, migrations, operational changes, and cross-team delivery risk. The method is less helpful when the team uses it as a substitute for real planning or as blame theater.

## Canonical origin and what is “official” here

- **Origin / lineage:** Popularized by Gary Klein through the premortem concept.
- **Canonical status:** Established risk-anticipation technique.
...
1. **Assume failure** — Use this part to move the team from raw input toward a decision or artifact.
2. **Generate reasons** — Use this part to move the team from raw input toward a decision or artifact.
3. **Cluster risks** — Use this part to move the team from raw input toward a decision or artifact.
4. **Plan mitigations** — Use this part to move the team from raw input toward a decision or artifact.
5. **Monitor leading signals** — Use this part to move the team from raw input toward a decision or artifact.
...
- **Primary fit:** large bets, launches, migrations, operational changes, and cross-team delivery risk
- **Secondary fit:** situations where you need to align multiple people around the same lens before committing time or budget.
- **Good complement to:** adjacent discovery or prioritization tools.
...
### Typical outputs
- risk register, mitigation plan, and early warning signals
...
**Practical caution:** The session works best before major commitment, when mitigation is still cheap.

## Related frameworks

- No adjacent frameworks listed.
...
- Harvard Business Review premortem article
- PMFrame.works research workbook (uploaded source list)

## Bottom line

Pre-mortem is most useful when you need a **disciplined lens** for a specific kind of product problem—not as a universal answer, but as a way to improve the quality of thinking, collaboration, and decision-making around that problem.
