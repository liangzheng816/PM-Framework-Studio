...
language: "English"
confidence: "High"
canonical_status: "Canonical behavior-design model."
---
...
Fogg Behavior Model helps by imposing a **useful frame** on the work. It is especially helpful when you need to designing activation and habit-forming flows. The method is less helpful when the product still lacks a credible core value proposition or reliable retention signal.

## Canonical origin and what is “official” here

- **Origin / lineage:** Created by B.J. Fogg.
- **Canonical status:** Canonical behavior-design model.
...
### Canonical structure
1. **Motivation** — Use this part to move the team from raw input toward a decision or artifact.
2. **Ability** — Use this part to move the team from raw input toward a decision or artifact.
3. **Prompt** — Use this part to move the team from raw input toward a decision or artifact.
...
**Practical caution:** This framework is strongest when used to designing activation and habit-forming flows
...
Fogg Behavior Model is most useful when you need a **disciplined lens** for a specific kind of product problem—not as a universal answer, but as a way to improve the quality of thinking, collaboration, and decision-making around that problem.
