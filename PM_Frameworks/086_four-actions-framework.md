...
language: "English"
confidence: "High"
canonical_status: "Canonical Blue Ocean operating tool."
---
...
Four Actions Framework is a **growth** framework used to identify where demand, retention, messaging, or economics can improve compounding growth. In the uploaded PMFrame workbook, it is described as: **Uses eliminate, reduce, raise, and create to redesign a value curve. Best as the operating tool inside Blue Ocean work.**. In practical product work, its value is that it gives teams a repeatable way to move from ambiguity to a clearer decision, artifact, or next experiment without pretending there is more certainty than the evidence actually supports.
...
Four Actions Framework helps by imposing a **useful frame** on the work. It is especially helpful when you need to funnel diagnosis, positioning, monetization, launch planning, and durable growth design. The method is less helpful when the product still lacks a credible core value proposition or reliable retention signal.

## Canonical origin and what is “official” here

- **Origin / lineage:** Created by W. Chan Kim and Renée Mauborgne as part of Blue Ocean Strategy.
- **Canonical status:** Canonical Blue Ocean operating tool.
...
### Canonical structure
1. **Eliminate** — Use this part to move the team from raw input toward a decision or artifact.
2. **Reduce** — Use this part to move the team from raw input toward a decision or artifact.
3. **Raise** — Use this part to move the team from raw input toward a decision or artifact.
4. **Create** — Use this part to move the team from raw input toward a decision or artifact.
...
- **Primary fit:** funnel diagnosis, positioning, monetization, launch planning, and durable growth design
- **Secondary fit:** situations where you need to align multiple people around the same lens before committing time or budget.
- **Good complement to:** Fogg Behavior Model, JTBD Growth Matrix.
...
- **Fogg Behavior Model** — Adjacent method in the same PMFrame cluster.
- **JTBD Growth Matrix** — Adjacent method in the same PMFrame cluster.
- **Ansoff Matrix** — Adjacent method in the same PMFrame cluster.
...
Four Actions Framework is most useful when you need a **disciplined lens** for a specific kind of product problem—not as a universal answer, but as a way to improve the quality of thinking, collaboration, and decision-making around that problem.
