...
language: "English"
confidence: "High"
canonical_status: "Canonical synthesis method."
---
...
Affinity Diagram is a **user insights** framework used to turn ambiguous user evidence into a sharper picture of behavior, motivation, and unmet needs. In the uploaded PMFrame workbook, it is described as: **Clusters raw qualitative observations into themes and patterns. Best right after interviews, field notes, or open-ended surveys.**. In practical product work, its value is that it gives teams a repeatable way to move from ambiguity to a clearer decision, artifact, or next experiment without pretending there is more certainty than the evidence actually supports.
...
Affinity Diagram helps by imposing a **useful frame** on the work. It is especially helpful when you need to early discovery, exploratory research, and reframing decisions around real user context. The method is less helpful when the team already needs a hard delivery plan or the main bottleneck is implementation rather than understanding.

## Canonical origin and what is “official” here

- **Origin / lineage:** Derived from the KJ Method created by Jiro Kawakita.
- **Canonical status:** Canonical synthesis method.
...
### Canonical structure
1. **Raw observations** — Use this part to move the team from raw input toward a decision or artifact.
2. **Cluster themes** — Use this part to move the team from raw input toward a decision or artifact.
3. **Label themes** — Use this part to move the team from raw input toward a decision or artifact.
4. **Higher-order groupings** — Use this part to move the team from raw input toward a decision or artifact.
5. **Implications** — Use this part to move the team from raw input toward a decision or artifact.

## When to use it

Use Affinity Diagram when:
...
- **Primary fit:** early discovery, exploratory research, and reframing decisions around real user context
- **Secondary fit:** situations where you need to align multiple people around the same lens before committing time or budget.
- **Good complement to:** Service Blueprint, Contextual Inquiry.
...
- KJ Method
- UX research synthesis practice
- PMFrame.works research workbook (uploaded source list)

## Bottom line

Affinity Diagram is most useful when you need a **disciplined lens** for a specific kind of product problem—not as a universal answer, but as a way to improve the quality of thinking, collaboration, and decision-making around that problem.
