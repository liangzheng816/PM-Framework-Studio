...
language: "English"
confidence: "High"
canonical_status: "Canonical Amazon product-definition method."
---
...
Working Backwards is a **problem framing** framework used to separate the real problem from noise, symptoms, assumptions, and premature solution ideas. In the uploaded PMFrame workbook, it is described as: **Starts with the customer-facing future state—often a press release/FAQ—and works backward into product scope. Best for new-product definition and strategic alignment.**. In practical product work, its value is that it gives teams a repeatable way to move from ambiguity to a clearer decision, artifact, or next experiment without pretending there is more certainty than the evidence actually supports.
...
Working Backwards helps by imposing a **useful frame** on the work. It is especially helpful when you need to new-product definition and strategic alignment. The method is less helpful when the real problem is already well evidenced and the team simply needs execution discipline.

## Canonical origin and what is “official” here

- **Origin / lineage:** Associated with Amazon and documented by Colin Bryar and Bill Carr.
- **Canonical status:** Canonical Amazon product-definition method.
...
### Canonical structure
1. **Press release** — Use this part to move the team from raw input toward a decision or artifact.
2. **FAQ** — Use this part to move the team from raw input toward a decision or artifact.
3. **Customer benefit** — Use this part to move the team from raw input toward a decision or artifact.
4. **Success metrics** — Use this part to move the team from raw input toward a decision or artifact.
5. **Backward plan** — Use this part to move the team from raw input toward a decision or artifact.
...
**Practical caution:** This framework is strongest when used to new-product definition and strategic alignment

## Related frameworks

- **Mental Models** — Adjacent method in the same PMFrame cluster.
- **CIRCLES Method** — Adjacent method in the same PMFrame cluster.
- **Event Storming** — Adjacent method in the same PMFrame cluster.
...
- Amazon PR/FAQ process
- PMFrame.works research workbook (uploaded source list)

## Bottom line

Working Backwards is most useful when you need a **disciplined lens** for a specific kind of product problem—not as a universal answer, but as a way to improve the quality of thinking, collaboration, and decision-making around that problem.
