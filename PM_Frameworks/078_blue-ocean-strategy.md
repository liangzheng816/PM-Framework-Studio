...
language: "English"
confidence: "High"
canonical_status: "Canonical strategic framework."
---
...
Blue Ocean Strategy helps by imposing a **useful frame** on the work. It is especially helpful when you need to category redesign and strategic repositioning. The method is less helpful when the product still lacks a credible core value proposition or reliable retention signal.

## Canonical origin and what is “official” here

- **Origin / lineage:** Created by W. Chan Kim and Renée Mauborgne.
- **Canonical status:** Canonical strategic framework.
...
### Canonical structure
1. **Value innovation** — Use this part to move the team from raw input toward a decision or artifact.
2. **Eliminate** — Use this part to move the team from raw input toward a decision or artifact.
3. **Reduce** — Use this part to move the team from raw input toward a decision or artifact.
4. **Raise** — Use this part to move the team from raw input toward a decision or artifact.
5. **Create** — Use this part to move the team from raw input toward a decision or artifact.
...
**Practical caution:** Use it to redesign the value curve, not just to produce a high-level positioning slide.
...
Blue Ocean Strategy is most useful when you need a **disciplined lens** for a specific kind of product problem—not as a universal answer, but as a way to improve the quality of thinking, collaboration, and decision-making around that problem.
