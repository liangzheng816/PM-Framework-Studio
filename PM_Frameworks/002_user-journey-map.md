...
language: "English"
confidence: "Moderate"
canonical_status: "Established UX mapping technique; no single owner, but strong UX canon."
---
...
User Journey Map helps by imposing a **useful frame** on the work. It is especially helpful when you need to seeing where experience breaks and where redesign will matter most. The method is less helpful when the team already needs a hard delivery plan or the main bottleneck is implementation rather than understanding.

## Canonical origin and what is “official” here

- **Origin / lineage:** Commonly documented by Nielsen Norman Group and service-design practice.
- **Canonical status:** Established UX mapping technique; no single owner, but strong UX canon.
...
1. **Actor / persona** — Use this part to move the team from raw input toward a decision or artifact.
2. **Journey stages** — Use this part to move the team from raw input toward a decision or artifact.
3. **Touchpoints** — Use this part to move the team from raw input toward a decision or artifact.
4. **Actions** — Use this part to move the team from raw input toward a decision or artifact.
5. **Thoughts and feelings** — Use this part to move the team from raw input toward a decision or artifact.
6. **Pain points** — Use this part to move the team from raw input toward a decision or artifact.
7. **Opportunities** — Use this part to move the team from raw input toward a decision or artifact.

## When to use it

Use User Journey Map when:
...
- **Primary fit:** seeing where experience breaks and where redesign will matter most
- **Secondary fit:** situations where you need to align multiple people around the same lens before committing time or budget.
- **Good complement to:** Design Thinking, Empathy Map.
...
**Practical caution:** It works best when the map represents a specific actor, scenario, and time horizon rather than 'the whole experience' at once.
...
- Nielsen Norman Group on customer journey maps
- Service design journey mapping practice
- PMFrame.works research workbook (uploaded source list)

## Bottom line

User Journey Map is most useful when you need a **disciplined lens** for a specific kind of product problem—not as a universal answer, but as a way to improve the quality of thinking, collaboration, and decision-making around that problem.
