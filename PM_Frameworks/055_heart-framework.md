...
language: "English"
confidence: "High"
canonical_status: "Canonical UX measurement framework."
---
...
HEART Framework is a **validation** framework used to reduce uncertainty by turning product beliefs into tests, metrics, and evidence-backed decisions. In the uploaded PMFrame workbook, it is described as: **Google’s UX measurement model covering Happiness, Engagement, Adoption, Retention, and Task success. Best for turning UX quality into trackable metrics.**. In practical product work, its value is that it gives teams a repeatable way to move from ambiguity to a clearer decision, artifact, or next experiment without pretending there is more certainty than the evidence actually supports.
...
HEART Framework helps by imposing a **useful frame** on the work. It is especially helpful when you need to turning UX quality into trackable metrics. The method is less helpful when there is no meaningful hypothesis yet or no decision will change based on the evidence.

## Canonical origin and what is “official” here

- **Origin / lineage:** Created at Google.
- **Canonical status:** Canonical UX measurement framework.
...
### Canonical structure
1. **Happiness** — Use this part to move the team from raw input toward a decision or artifact.
2. **Engagement** — Use this part to move the team from raw input toward a decision or artifact.
3. **Adoption** — Use this part to move the team from raw input toward a decision or artifact.
4. **Retention** — Use this part to move the team from raw input toward a decision or artifact.
5. **Task success** — Use this part to move the team from raw input toward a decision or artifact.
...
- **Primary fit:** turning UX quality into trackable metrics
- **Secondary fit:** situations where you need to align multiple people around the same lens before committing time or budget.
- **Good complement to:** Task Completion Rate Test, Idea Feasibility Threshold.
...
**Practical caution:** This framework is strongest when used to turning UX quality into trackable metrics
...
- **Lean UX Canvas** — Adjacent method in the same PMFrame cluster.
...
HEART Framework is most useful when you need a **disciplined lens** for a specific kind of product problem—not as a universal answer, but as a way to improve the quality of thinking, collaboration, and decision-making around that problem.
