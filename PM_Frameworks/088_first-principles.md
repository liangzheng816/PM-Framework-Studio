...
language: "English"
confidence: "Moderate"
canonical_status: "Ancient philosophical concept; product application is practitioner-driven."
---
...
First Principles is a **systems thinking** framework used to understand the broader structure around the product, including dependencies, incentives, constraints, and feedback loops. In the uploaded PMFrame workbook, it is described as: **Reduces a problem to irreducible truths and rebuilds from there. Best when industry convention has calcified bad assumptions.**. In practical product work, its value is that it gives teams a repeatable way to move from ambiguity to a clearer decision, artifact, or next experiment without pretending there is more certainty than the evidence actually supports.
...
First Principles helps by imposing a **useful frame** on the work. It is especially helpful when you need to strategy, platform design, portfolio planning, operating-model choices, and recurring systemic issues. The method is less helpful when the question is narrow, tactical, and does not require a system-level view.

## Canonical origin and what is “official” here

- **Origin / lineage:** Rooted in Aristotle, later popularized in engineering and strategy circles including Elon Musk.
- **Canonical status:** Ancient philosophical concept; product application is practitioner-driven.
...
1. **Decompose assumptions** — Use this part to move the team from raw input toward a decision or artifact.
2. **Identify irreducible truths** — Use this part to move the team from raw input toward a decision or artifact.
3. **Rebuild from basics** — Use this part to move the team from raw input toward a decision or artifact.
4. **Compare with current convention** — Use this part to move the team from raw input toward a decision or artifact.
...
- **Primary fit:** strategy, platform design, portfolio planning, operating-model choices, and recurring systemic issues
- **Secondary fit:** situations where you need to align multiple people around the same lens before committing time or budget.
- **Good complement to:** Wardley Mapping, Three Horizons.
...
- **Wardley Mapping** — Adjacent method in the same PMFrame cluster.
...
- Engineering first-principles reasoning
- PMFrame.works research workbook (uploaded source list)

## Bottom line

First Principles is most useful when you need a **disciplined lens** for a specific kind of product problem—not as a universal answer, but as a way to improve the quality of thinking, collaboration, and decision-making around that problem.
