...
language: "English"
confidence: "Moderate"
canonical_status: "Established strategic practice, not a single canonical template."
---
...
Competitor Analysis is a **problem framing** framework used to separate the real problem from noise, symptoms, assumptions, and premature solution ideas. In the uploaded PMFrame workbook, it is described as: **Compares direct, indirect, and substitute competitors across positioning, features, business model, and gaps. Best for differentiation and market narrative work.**. In practical product work, its value is that it gives teams a repeatable way to move from ambiguity to a clearer decision, artifact, or next experiment without pretending there is more certainty than the evidence actually supports.
...
Competitor Analysis helps by imposing a **useful frame** on the work. It is especially helpful when you need to differentiation and market narrative work. The method is less helpful when the real problem is already well evidenced and the team simply needs execution discipline.

## Canonical origin and what is “official” here

- **Origin / lineage:** Standard product marketing and strategy discipline.
- **Canonical status:** Established strategic practice, not a single canonical template.
...
1. **Competitor set** — Use this part to move the team from raw input toward a decision or artifact.
2. **Positioning** — Use this part to move the team from raw input toward a decision or artifact.
3. **Offer / features** — Use this part to move the team from raw input toward a decision or artifact.
4. **Go-to-market** — Use this part to move the team from raw input toward a decision or artifact.
5. **Strengths / gaps** — Use this part to move the team from raw input toward a decision or artifact.
6. **Counter-positioning** — Use this part to move the team from raw input toward a decision or artifact.
...
**Practical caution:** This framework is strongest when used to differentiation and market narrative work

## Related frameworks

- **PESTLE Analysis** — Adjacent method in the same PMFrame cluster.
- **SWOT** — Adjacent method in the same PMFrame cluster.

## References and authority trail

The note was grounded in the following authority sources or canonical references:
- Product marketing practice
- Competitive strategy literature
- PMFrame.works research workbook (uploaded source list)

## Bottom line

Competitor Analysis is most useful when you need a **disciplined lens** for a specific kind of product problem—not as a universal answer, but as a way to improve the quality of thinking, collaboration, and decision-making around that problem.
