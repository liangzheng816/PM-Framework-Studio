...
language: "English"
confidence: "High"
canonical_status: "Canonical SaaS and growth finance ratio."
---
...
LTV/CAC is a **growth** framework used to identify where demand, retention, messaging, or economics can improve compounding growth. In the uploaded PMFrame workbook, it is described as: **Compares lifetime value against acquisition cost to judge the economics of growth. Best for channel allocation and board-level growth discipline.**. In practical product work, its value is that it gives teams a repeatable way to move from ambiguity to a clearer decision, artifact, or next experiment without pretending there is more certainty than the evidence actually supports.
...
LTV/CAC helps by imposing a **useful frame** on the work. It is especially helpful when you need to channel allocation and board-level growth discipline. The method is less helpful when the product still lacks a credible core value proposition or reliable retention signal.

## Canonical origin and what is “official” here

- **Origin / lineage:** Startup finance and growth management practice.
- **Canonical status:** Canonical SaaS and growth finance ratio.
...
### Canonical structure
1. **Customer acquisition cost** — Use this part to move the team from raw input toward a decision or artifact.
2. **Lifetime value** — Use this part to move the team from raw input toward a decision or artifact.
3. **Payback period** — Use this part to move the team from raw input toward a decision or artifact.
4. **Segment mix** — Use this part to move the team from raw input toward a decision or artifact.
5. **Channel efficiency** — Use this part to move the team from raw input toward a decision or artifact.
...
- **Primary fit:** channel allocation and board-level growth discipline
- **Secondary fit:** situations where you need to align multiple people around the same lens before committing time or budget.
- **Good complement to:** Competitive Positioning Map, Blue Ocean Strategy.
...
**Practical caution:** This framework is strongest when used to channel allocation and board-level growth discipline
...
- **Go-to-Market Strategy** — Adjacent method in the same PMFrame cluster.
...
- SaaS metrics practice
- Growth finance guidance
- PMFrame.works research workbook (uploaded source list)

## Bottom line

LTV/CAC is most useful when you need a **disciplined lens** for a specific kind of product problem—not as a universal answer, but as a way to improve the quality of thinking, collaboration, and decision-making around that problem.
