...
language: "English"
confidence: "High"
canonical_status: "Canonical habit-forming product model."
---
...
Hook Model is a **growth** framework used to identify where demand, retention, messaging, or economics can improve compounding growth. In the uploaded PMFrame workbook, it is described as: **Designs trigger → action → variable reward → investment loops to encourage habit formation. Best for repeat-use products where habits matter.**. In practical product work, its value is that it gives teams a repeatable way to move from ambiguity to a clearer decision, artifact, or next experiment without pretending there is more certainty than the evidence actually supports.
...
Hook Model helps by imposing a **useful frame** on the work. It is especially helpful when you need to repeat-use products where habits matter. The method is less helpful when the product still lacks a credible core value proposition or reliable retention signal.

## Canonical origin and what is “official” here

- **Origin / lineage:** Created by Nir Eyal.
- **Canonical status:** Canonical habit-forming product model.
...
### Canonical structure
1. **Trigger** — Use this part to move the team from raw input toward a decision or artifact.
2. **Action** — Use this part to move the team from raw input toward a decision or artifact.
3. **Variable reward** — Use this part to move the team from raw input toward a decision or artifact.
4. **Investment** — Use this part to move the team from raw input toward a decision or artifact.
...
**Practical caution:** This framework is strongest when used to repeat-use products where habits matter
...
Hook Model is most useful when you need a **disciplined lens** for a specific kind of product problem—not as a universal answer, but as a way to improve the quality of thinking, collaboration, and decision-making around that problem.
