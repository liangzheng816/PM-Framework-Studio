...
language: "English"
confidence: "Moderate"
canonical_status: "Established synthesis canvas with a widely recognized quadrant model."
---
...
Empathy Map is a **user insights** framework used to turn ambiguous user evidence into a sharper picture of behavior, motivation, and unmet needs. In the uploaded PMFrame workbook, it is described as: **Structures what users say, think, feel, and do so teams stop projecting their own assumptions. Best for synthesizing interview findings into a shared user picture.**. In practical product work, its value is that it gives teams a repeatable way to move from ambiguity to a clearer decision, artifact, or next experiment without pretending there is more certainty than the evidence actually supports.
...
Empathy Map helps by imposing a **useful frame** on the work. It is especially helpful when you need to synthesizing interview findings into a shared user picture. The method is less helpful when the team already needs a hard delivery plan or the main bottleneck is implementation rather than understanding.

## Canonical origin and what is “official” here

- **Origin / lineage:** Popularized by XPLANE and later used broadly in design and product teams.
- **Canonical status:** Established synthesis canvas with a widely recognized quadrant model.
...
### Canonical structure
1. **Says** — Use this part to move the team from raw input toward a decision or artifact.
2. **Thinks** — Use this part to move the team from raw input toward a decision or artifact.
3. **Feels** — Use this part to move the team from raw input toward a decision or artifact.
4. **Does** — Use this part to move the team from raw input toward a decision or artifact.

## When to use it

Use Empathy Map when:
...
- **Primary fit:** synthesizing interview findings into a shared user picture
- **Secondary fit:** situations where you need to align multiple people around the same lens before committing time or budget.
- **Good complement to:** Design Thinking, User Journey Map.
...
**Practical caution:** Treat it as a synthesis artifact built from evidence, not a substitute for research.

## Related frameworks

- **Design Thinking** — Adjacent method in the same PMFrame cluster.
...
- XPLANE empathy map
- Nielsen Norman Group empathy mapping guidance
- PMFrame.works research workbook (uploaded source list)

## Bottom line

Empathy Map is most useful when you need a **disciplined lens** for a specific kind of product problem—not as a universal answer, but as a way to improve the quality of thinking, collaboration, and decision-making around that problem.
