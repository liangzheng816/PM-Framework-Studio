...
language: "English"
confidence: "High"
canonical_status: "Canonical agile product-planning artifact."
---
...
User Story Map is a **execution** framework used to translate intent into scope, sequence, ownership, and repeatable delivery decisions. In the uploaded PMFrame workbook, it is described as: **Organizes work by user activities horizontally and delivery depth vertically. Best for seeing scope, sequencing releases, and keeping teams user-centered.**. In practical product work, its value is that it gives teams a repeatable way to move from ambiguity to a clearer decision, artifact, or next experiment without pretending there is more certainty than the evidence actually supports.
...
User Story Map helps by imposing a **useful frame** on the work. It is especially helpful when you need to seeing scope, sequencing releases, and keeping teams user-centered. The method is less helpful when the team is still unclear about the user problem or the evidence base behind the work.

## Canonical origin and what is “official” here

- **Origin / lineage:** Created by Jeff Patton.
- **Canonical status:** Canonical agile product-planning artifact.
...
### Canonical structure
1. **Backbone activities** — Use this part to move the team from raw input toward a decision or artifact.
2. **Steps** — Use this part to move the team from raw input toward a decision or artifact.
3. **Stories** — Use this part to move the team from raw input toward a decision or artifact.
4. **Release slices** — Use this part to move the team from raw input toward a decision or artifact.

## When to use it

Use User Story Map when:
...
**Practical caution:** The map should preserve the user backbone; once it becomes a feature inventory, it loses its point.

## Related frameworks

- **RICE** — Adjacent method in the same PMFrame cluster.
...
- Agile planning practice
- PMFrame.works research workbook (uploaded source list)

## Bottom line

User Story Map is most useful when you need a **disciplined lens** for a specific kind of product problem—not as a universal answer, but as a way to improve the quality of thinking, collaboration, and decision-making around that problem.
