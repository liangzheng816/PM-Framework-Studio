---
title: "How-Now-Wow Matrix"
category: "Ideation"
pmframe_order: 036
language: "English"
confidence: "Moderate"
canonical_status: "Practitioner ideation-sort method."
---
...
How-Now-Wow Matrix is a **ideation** framework used to expand the option space before the team commits too early to one direction. In the uploaded PMFrame workbook, it is described as: **Sorts ideas by originality and feasibility into safe, creative, and breakthrough buckets. Best after ideation when deciding which concepts to mature.**. In practical product work, its value is that it gives teams a repeatable way to move from ambiguity to a clearer decision, artifact, or next experiment without pretending there is more certainty than the evidence actually supports.
...
How-Now-Wow Matrix helps by imposing a **useful frame** on the work. It is especially helpful when you need to concept generation, workshop facilitation, design exploration, and finding non-obvious options. The method is less helpful when the main uncertainty is no longer idea quality but evidence, feasibility, or delivery.

## Canonical origin and what is “official” here

- **Origin / lineage:** Facilitation tool for sorting ideas by originality and feasibility.
- **Canonical status:** Practitioner ideation-sort method.
...
1. **How** — Use this part to move the team from raw input toward a decision or artifact.
2. **Now** — Use this part to move the team from raw input toward a decision or artifact.
3. **Wow** — Use this part to move the team from raw input toward a decision or artifact.

## When to use it

Use How-Now-Wow Matrix when:
...
- **Primary fit:** concept generation, workshop facilitation, design exploration, and finding non-obvious options
- **Secondary fit:** situations where you need to align multiple people around the same lens before committing time or budget.
- **Good complement to:** Analogical Thinking, Value Proposition Canvas.
...
- **Value Proposition Canvas** — Adjacent method in the same PMFrame cluster.
...
- Innovation workshop methods
- PMFrame.works research workbook (uploaded source list)

## Bottom line

How-Now-Wow Matrix is most useful when you need a **disciplined lens** for a specific kind of product problem—not as a universal answer, but as a way to improve the quality of thinking, collaboration, and decision-making around that problem.
