---
title: "HMW Problem Frame"
category: "Problem framing"
pmframe_order: 015
language: "English"
confidence: "Moderate"
canonical_status: "Widely used design framing technique."
---
...
HMW Problem Frame is a **problem framing** framework used to separate the real problem from noise, symptoms, assumptions, and premature solution ideas. In the uploaded PMFrame workbook, it is described as: **Converts insights into ‘How might we…?’ opportunity statements that preserve room for solutions. Best when research is rich but design direction is still fuzzy.**. In practical product work, its value is that it gives teams a repeatable way to move from ambiguity to a clearer decision, artifact, or next experiment without pretending there is more certainty than the evidence actually supports.
...
HMW Problem Frame helps by imposing a **useful frame** on the work. It is especially helpful when you need to messy requests, recurring issues, strategic ambiguity, and stakeholder disagreement about what to solve. The method is less helpful when the real problem is already well evidenced and the team simply needs execution discipline.

## Canonical origin and what is “official” here

- **Origin / lineage:** Popularized in design thinking and innovation workshops.
- **Canonical status:** Widely used design framing technique.
...
1. **User or actor** — Use this part to move the team from raw input toward a decision or artifact.
2. **Need or tension** — Use this part to move the team from raw input toward a decision or artifact.
3. **Desired progress** — Use this part to move the team from raw input toward a decision or artifact.
4. **Open-ended reframe** — Use this part to move the team from raw input toward a decision or artifact.

## When to use it

Use HMW Problem Frame when:
...
- **Good complement to:** Musk’s Five-Step Method, 5 Whys.
...
- **Musk’s Five-Step Method** — Adjacent method in the same PMFrame cluster.
- **5 Whys** — Adjacent method in the same PMFrame cluster.
- **POV Statement** — Adjacent method in the same PMFrame cluster.
- **Problem Tree** — Adjacent method in the same PMFrame cluster.

## References and authority trail

The note was grounded in the following authority sources or canonical references:
- Design thinking HMW practice
- IDEO ideation framing
- PMFrame.works research workbook (uploaded source list)

## Bottom line

HMW Problem Frame is most useful when you need a **disciplined lens** for a specific kind of product problem—not as a universal answer, but as a way to improve the quality of thinking, collaboration, and decision-making around that problem.
