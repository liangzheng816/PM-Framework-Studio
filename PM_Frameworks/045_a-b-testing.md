...
language: "English"
confidence: "High"
canonical_status: "Canonical controlled-experiment method."
---
...
A/B Testing helps by imposing a **useful frame** on the work. It is especially helpful when you need to tuning product decisions where behavior can be measured at scale. The method is less helpful when there is no meaningful hypothesis yet or no decision will change based on the evidence.

## Canonical origin and what is “official” here

- **Origin / lineage:** Statistical experiment design applied to digital products at scale.
- **Canonical status:** Canonical controlled-experiment method.
...
2. **Control** — Use this part to move the team from raw input toward a decision or artifact.
3. **Variant** — Use this part to move the team from raw input toward a decision or artifact.
4. **Success metric** — Use this part to move the team from raw input toward a decision or artifact.
5. **Significance and decision** — Use this part to move the team from raw input toward a decision or artifact.
...
- **Primary fit:** tuning product decisions where behavior can be measured at scale
- **Secondary fit:** situations where you need to align multiple people around the same lens before committing time or budget.
- **Good complement to:** Lean Startup MVP, Hypothesis Board.
...
**Practical caution:** A/B tests are powerful only when the treatment is meaningful, the metric is decision-relevant, and experiment quality is sound.

## Related frameworks

- **Lean Startup MVP** — Adjacent method in the same PMFrame cluster.
...
- Online controlled experiments literature
- Microsoft / Google experimentation practice
- PMFrame.works research workbook (uploaded source list)

## Bottom line

A/B Testing is most useful when you need a **disciplined lens** for a specific kind of product problem—not as a universal answer, but as a way to improve the quality of thinking, collaboration, and decision-making around that problem.
