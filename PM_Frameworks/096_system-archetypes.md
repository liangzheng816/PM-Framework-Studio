...
language: "English"
confidence: "High"
canonical_status: "Canonical systems-thinking teaching model."
---
...
System Archetypes helps by imposing a **useful frame** on the work. It is especially helpful when you need to diagnosing repeating organizational dysfunction. The method is less helpful when the question is narrow, tactical, and does not require a system-level view.

## Canonical origin and what is “official” here

- **Origin / lineage:** Popularized by Peter Senge and systems-thinking educators.
- **Canonical status:** Canonical systems-thinking teaching model.
...
### Canonical structure
1. **Limits to growth** — Use this part to move the team from raw input toward a decision or artifact.
2. **Shifting the burden** — Use this part to move the team from raw input toward a decision or artifact.
3. **Fixes that fail** — Use this part to move the team from raw input toward a decision or artifact.
4. **Tragedy of the commons** — Use this part to move the team from raw input toward a decision or artifact.
5. **Success to the successful** — Use this part to move the team from raw input toward a decision or artifact.

## When to use it

Use System Archetypes when:
...
- **Primary fit:** diagnosing repeating organizational dysfunction
- **Secondary fit:** situations where you need to align multiple people around the same lens before committing time or budget.
- **Good complement to:** Antifragile Design, Theory of Constraints.
...
**Practical caution:** This framework is strongest when used to diagnosing repeating organizational dysfunction
...
- Systems archetypes literature
- PMFrame.works research workbook (uploaded source list)

## Bottom line

System Archetypes is most useful when you need a **disciplined lens** for a specific kind of product problem—not as a universal answer, but as a way to improve the quality of thinking, collaboration, and decision-making around that problem.
