...
language: "English"
confidence: "High"
canonical_status: "Canonical strategy mapping method."
---
...
Wardley Mapping is a **systems thinking** framework used to understand the broader structure around the product, including dependencies, incentives, constraints, and feedback loops. In the uploaded PMFrame workbook, it is described as: **Maps user needs to value-chain components and their stage of evolution. Best for technology strategy, make-vs-buy, and anticipating commoditization.**. In practical product work, its value is that it gives teams a repeatable way to move from ambiguity to a clearer decision, artifact, or next experiment without pretending there is more certainty than the evidence actually supports.
...
Wardley Mapping helps by imposing a **useful frame** on the work. It is especially helpful when you need to technology strategy, make-vs-buy, and anticipating commoditization. The method is less helpful when the question is narrow, tactical, and does not require a system-level view.

## Canonical origin and what is “official” here

- **Origin / lineage:** Created by Simon Wardley.
- **Canonical status:** Canonical strategy mapping method.
...
### Canonical structure
1. **User needs** — Use this part to move the team from raw input toward a decision or artifact.
2. **Value chain** — Use this part to move the team from raw input toward a decision or artifact.
3. **Evolution** — Use this part to move the team from raw input toward a decision or artifact.
4. **Movement and climate patterns** — Use this part to move the team from raw input toward a decision or artifact.
...
- **Primary fit:** technology strategy, make-vs-buy, and anticipating commoditization
- **Secondary fit:** situations where you need to align multiple people around the same lens before committing time or budget.
- **Good complement to:** First Principles, Three Horizons.
...
**Practical caution:** The map is strategic only when anchored to user needs; otherwise it becomes a technical inventory.

## Related frameworks

- **First Principles** — Adjacent method in the same PMFrame cluster.
...
- Wardley maps practice
- PMFrame.works research workbook (uploaded source list)

## Bottom line

Wardley Mapping is most useful when you need a **disciplined lens** for a specific kind of product problem—not as a universal answer, but as a way to improve the quality of thinking, collaboration, and decision-making around that problem.
