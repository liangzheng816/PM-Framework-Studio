...
language: "English"
confidence: "High"
canonical_status: "Canonical industry-structure framework."
---
...
Porter Five Forces helps by imposing a **useful frame** on the work. It is especially helpful when you need to industry attractiveness analysis. The method is less helpful when the question is narrow, tactical, and does not require a system-level view.

## Canonical origin and what is “official” here

- **Origin / lineage:** Created by Michael Porter.
- **Canonical status:** Canonical industry-structure framework.
...
### Canonical structure
1. **Supplier power** — Use this part to move the team from raw input toward a decision or artifact.
2. **Buyer power** — Use this part to move the team from raw input toward a decision or artifact.
3. **Competitive rivalry** — Use this part to move the team from raw input toward a decision or artifact.
4. **Threat of substitutes** — Use this part to move the team from raw input toward a decision or artifact.
5. **Threat of new entrants** — Use this part to move the team from raw input toward a decision or artifact.

## When to use it

Use Porter Five Forces when:
...
**Practical caution:** This framework is strongest when used to industry attractiveness analysis
...
Porter Five Forces is most useful when you need a **disciplined lens** for a specific kind of product problem—not as a universal answer, but as a way to improve the quality of thinking, collaboration, and decision-making around that problem.
