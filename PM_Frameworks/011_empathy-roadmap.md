...
language: "English"
confidence: "Moderate"
canonical_status: "Practitioner synthesis method; no single canonical source."
---
...
Empathy Roadmap is a **user insights** framework used to turn ambiguous user evidence into a sharper picture of behavior, motivation, and unmet needs. In the uploaded PMFrame workbook, it is described as: **Extends empathy work across time and stages so teams can track how a user’s mindset shifts during a journey. Best for emotionally sensitive or multi-step experiences.**. In practical product work, its value is that it gives teams a repeatable way to move from ambiguity to a clearer decision, artifact, or next experiment without pretending there is more certainty than the evidence actually supports.
...
Empathy Roadmap helps by imposing a **useful frame** on the work. It is especially helpful when you need to emotionally sensitive or multi-step experiences. The method is less helpful when the team already needs a hard delivery plan or the main bottleneck is implementation rather than understanding.

## Canonical origin and what is “official” here

- **Origin / lineage:** An extension of empathy mapping across time, stages, and changing emotional state.
- **Canonical status:** Practitioner synthesis method; no single canonical source.
...
1. **Journey phase** — Use this part to move the team from raw input toward a decision or artifact.
2. **Context** — Use this part to move the team from raw input toward a decision or artifact.
3. **Emotion shift** — Use this part to move the team from raw input toward a decision or artifact.
4. **Need shift** — Use this part to move the team from raw input toward a decision or artifact.
5. **Trust / confidence shift** — Use this part to move the team from raw input toward a decision or artifact.
6. **Support implication** — Use this part to move the team from raw input toward a decision or artifact.

## When to use it

Use Empathy Roadmap when:
...
**Practical caution:** This framework is strongest when used to emotionally sensitive or multi-step experiences

## Related frameworks

- **Affinity Diagram** — Adjacent method in the same PMFrame cluster.
- **Diary Study** — Adjacent method in the same PMFrame cluster.
...
Empathy Roadmap is most useful when you need a **disciplined lens** for a specific kind of product problem—not as a universal answer, but as a way to improve the quality of thinking, collaboration, and decision-making around that problem.
