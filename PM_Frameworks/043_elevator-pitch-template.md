...
language: "English"
confidence: "Moderate"
canonical_status: "Common narrative template, not a single canonical source."
---
...
Elevator Pitch Template is a **ideation** framework used to expand the option space before the team commits too early to one direction. In the uploaded PMFrame workbook, it is described as: **Compresses target user, problem, solution, and differentiation into a short structured story. Best for product narrative discipline.**. In practical product work, its value is that it gives teams a repeatable way to move from ambiguity to a clearer decision, artifact, or next experiment without pretending there is more certainty than the evidence actually supports.
...
Elevator Pitch Template helps by imposing a **useful frame** on the work. It is especially helpful when you need to product narrative discipline. The method is less helpful when the main uncertainty is no longer idea quality but evidence, feasibility, or delivery.

## Canonical origin and what is “official” here

- **Origin / lineage:** A communication pattern used in startup, product, and investor contexts.
- **Canonical status:** Common narrative template, not a single canonical source.
...
1. **Target user** — Use this part to move the team from raw input toward a decision or artifact.
2. **Problem** — Use this part to move the team from raw input toward a decision or artifact.
3. **Solution** — Use this part to move the team from raw input toward a decision or artifact.
4. **Differentiation** — Use this part to move the team from raw input toward a decision or artifact.
5. **Proof / ask** — Use this part to move the team from raw input toward a decision or artifact.

## When to use it

Use Elevator Pitch Template when:
...
**Practical caution:** This framework is strongest when used to product narrative discipline
...
- Product narrative methods
- PMFrame.works research workbook (uploaded source list)

## Bottom line

Elevator Pitch Template is most useful when you need a **disciplined lens** for a specific kind of product problem—not as a universal answer, but as a way to improve the quality of thinking, collaboration, and decision-making around that problem.
