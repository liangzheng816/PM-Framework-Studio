...
language: "English"
confidence: "Moderate"
canonical_status: "Broad family of methods rather than one single template."
---
...
Root Cause Analysis helps by imposing a **useful frame** on the work. It is especially helpful when you need to messy requests, recurring issues, strategic ambiguity, and stakeholder disagreement about what to solve. The method is less helpful when the real problem is already well evidenced and the team simply needs execution discipline.

## Canonical origin and what is “official” here

- **Origin / lineage:** Used in quality management, reliability engineering, and incident investigation.
- **Canonical status:** Broad family of methods rather than one single template.
...
1. **Problem definition** — Use this part to move the team from raw input toward a decision or artifact.
2. **Evidence collection** — Use this part to move the team from raw input toward a decision or artifact.
3. **Cause analysis** — Use this part to move the team from raw input toward a decision or artifact.
4. **Verification** — Use this part to move the team from raw input toward a decision or artifact.
5. **Corrective / preventive action** — Use this part to move the team from raw input toward a decision or artifact.
...
- **Good complement to:** Iceberg Model, Double Diamond.
...
- Quality engineering literature
- PMFrame.works research workbook (uploaded source list)

## Bottom line

Root Cause Analysis is most useful when you need a **disciplined lens** for a specific kind of product problem—not as a universal answer, but as a way to improve the quality of thinking, collaboration, and decision-making around that problem.
