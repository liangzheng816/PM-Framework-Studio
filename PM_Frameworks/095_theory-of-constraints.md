...
language: "English"
confidence: "High"
canonical_status: "Canonical operations framework."
---
...
Theory of Constraints is a **systems thinking** framework used to understand the broader structure around the product, including dependencies, incentives, constraints, and feedback loops. In the uploaded PMFrame workbook, it is described as: **Finds and elevates the bottleneck that limits system throughput. Best for operational improvement and delivery-flow optimization.**. In practical product work, its value is that it gives teams a repeatable way to move from ambiguity to a clearer decision, artifact, or next experiment without pretending there is more certainty than the evidence actually supports.
...
Theory of Constraints helps by imposing a **useful frame** on the work. It is especially helpful when you need to operational improvement and delivery-flow optimization. The method is less helpful when the question is narrow, tactical, and does not require a system-level view.

## Canonical origin and what is “official” here

- **Origin / lineage:** Created by Eliyahu Goldratt.
- **Canonical status:** Canonical operations framework.
...
### Canonical structure
1. **Identify constraint** — Use this part to move the team from raw input toward a decision or artifact.
2. **Exploit constraint** — Use this part to move the team from raw input toward a decision or artifact.
3. **Subordinate other work** — Use this part to move the team from raw input toward a decision or artifact.
4. **Elevate constraint** — Use this part to move the team from raw input toward a decision or artifact.
5. **Repeat** — Use this part to move the team from raw input toward a decision or artifact.

## When to use it

Use Theory of Constraints when:
...
- **Primary fit:** operational improvement and delivery-flow optimization
- **Secondary fit:** situations where you need to align multiple people around the same lens before committing time or budget.
- **Good complement to:** Product Lifecycle Management, Antifragile Design.
...
**Practical caution:** Local optimization often worsens the whole system; TOC works because it forces attention to the true bottleneck.
...
- **Innovation Portfolio Balance** — Adjacent method in the same PMFrame cluster.
...
Theory of Constraints is most useful when you need a **disciplined lens** for a specific kind of product problem—not as a universal answer, but as a way to improve the quality of thinking, collaboration, and decision-making around that problem.
