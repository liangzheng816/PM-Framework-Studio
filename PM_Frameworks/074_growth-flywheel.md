...
language: "English"
confidence: "High"
canonical_status: "Canonical growth systems concept, though each flywheel is bespoke."
---
...
Growth Flywheel is a **growth** framework used to identify where demand, retention, messaging, or economics can improve compounding growth. In the uploaded PMFrame workbook, it is described as: **Looks for self-reinforcing loops where one gain drives the next. Best for compounding growth beyond paid acquisition.**. In practical product work, its value is that it gives teams a repeatable way to move from ambiguity to a clearer decision, artifact, or next experiment without pretending there is more certainty than the evidence actually supports.
...
Growth Flywheel helps by imposing a **useful frame** on the work. It is especially helpful when you need to compounding growth beyond paid acquisition. The method is less helpful when the product still lacks a credible core value proposition or reliable retention signal.

## Canonical origin and what is “official” here

- **Origin / lineage:** Popularized in strategy and growth thinking, with famous company-specific examples.
- **Canonical status:** Canonical growth systems concept, though each flywheel is bespoke.
...
### Canonical structure
1. **Loop trigger** — Use this part to move the team from raw input toward a decision or artifact.
2. **Value creation** — Use this part to move the team from raw input toward a decision or artifact.
3. **Reinforcement** — Use this part to move the team from raw input toward a decision or artifact.
4. **Compounding metrics** — Use this part to move the team from raw input toward a decision or artifact.
5. **Friction points** — Use this part to move the team from raw input toward a decision or artifact.

## When to use it

Use Growth Flywheel when:
...
**Practical caution:** This framework is strongest when used to compounding growth beyond paid acquisition

## Related frameworks

- **AARRR Pirates** — Adjacent method in the same PMFrame cluster.
...
- Flywheel strategy literature
- Growth systems practice
- PMFrame.works research workbook (uploaded source list)

## Bottom line

Growth Flywheel is most useful when you need a **disciplined lens** for a specific kind of product problem—not as a universal answer, but as a way to improve the quality of thinking, collaboration, and decision-making around that problem.
