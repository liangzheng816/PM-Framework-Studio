...
language: "English"
confidence: "High"
canonical_status: "Canonical lean experimentation method."
---
...
2. **MVP** — Use this part to move the team from raw input toward a decision or artifact.
...
5. **Persevere or pivot** — Use this part to move the team from raw input toward a decision or artifact.

## When to use it

Use Lean Startup MVP when:
...
- The Lean Startup
- Lean experimentation practice
- PMFrame.works research workbook (uploaded source list)

## Bottom line

Lean Startup MVP is most useful when you need a **disciplined lens** for a specific kind of product problem—not as a universal answer, but as a way to improve the quality of thinking, collaboration, and decision-making around that problem.
