...
language: "English"
confidence: "High"
canonical_status: "Canonical quality and satisfaction model."
---
...
Kano Model helps by imposing a **useful frame** on the work. It is especially helpful when you need to feature prioritization when not all improvements create equal user value. The method is less helpful when the team already needs a hard delivery plan or the main bottleneck is implementation rather than understanding.

## Canonical origin and what is “official” here

- **Origin / lineage:** Developed by Noriaki Kano in the 1980s.
- **Canonical status:** Canonical quality and satisfaction model.
...
### Canonical structure
1. **Must-be** — Use this part to move the team from raw input toward a decision or artifact.
2. **Performance** — Use this part to move the team from raw input toward a decision or artifact.
3. **Attractive / delighters** — Use this part to move the team from raw input toward a decision or artifact.
4. **Indifferent** — Use this part to move the team from raw input toward a decision or artifact.
5. **Reverse** — Use this part to move the team from raw input toward a decision or artifact.
...
- **Primary fit:** feature prioritization when not all improvements create equal user value
- **Secondary fit:** situations where you need to align multiple people around the same lens before committing time or budget.
- **Good complement to:** JTBD, Five-Layer User Interview.
...
**Practical caution:** Use it after basic user needs are understood but before the team turns every request into a roadmap commitment.
...
- Noriaki Kano model literature
- Product prioritization applications of Kano
- PMFrame.works research workbook (uploaded source list)

## Bottom line

Kano Model is most useful when you need a **disciplined lens** for a specific kind of product problem—not as a universal answer, but as a way to improve the quality of thinking, collaboration, and decision-making around that problem.
