...
language: "English"
confidence: "High"
canonical_status: "Canonical user research method."
---
...
Contextual Inquiry helps by imposing a **useful frame** on the work. It is especially helpful when you need to understanding workarounds, context, and tacit behavior. The method is less helpful when the team already needs a hard delivery plan or the main bottleneck is implementation rather than understanding.

## Canonical origin and what is “official” here

- **Origin / lineage:** Developed by Karen Holtzblatt and Hugh Beyer in contextual design.
- **Canonical status:** Canonical user research method.
...
### Canonical structure
1. **Context** — Use this part to move the team from raw input toward a decision or artifact.
2. **Partnership** — Use this part to move the team from raw input toward a decision or artifact.
3. **Interpretation** — Use this part to move the team from raw input toward a decision or artifact.
4. **Focus** — Use this part to move the team from raw input toward a decision or artifact.
...
**Practical caution:** This framework is strongest when used to understanding workarounds, context, and tacit behavior
...
- Field research practice in UX
- PMFrame.works research workbook (uploaded source list)

## Bottom line

Contextual Inquiry is most useful when you need a **disciplined lens** for a specific kind of product problem—not as a universal answer, but as a way to improve the quality of thinking, collaboration, and decision-making around that problem.
