---
title: "Task Completion Rate Test"
category: "Validation"
pmframe_order: 053
language: "English"
confidence: "High"
canonical_status: "Canonical usability metric."
---
...
Task Completion Rate Test is a **validation** framework used to reduce uncertainty by turning product beliefs into tests, metrics, and evidence-backed decisions. In the uploaded PMFrame workbook, it is described as: **Measures whether users can successfully finish a core task unaided. Best for objective usability benchmarking.**. In practical product work, its value is that it gives teams a repeatable way to move from ambiguity to a clearer decision, artifact, or next experiment without pretending there is more certainty than the evidence actually supports.
...
Task Completion Rate Test helps by imposing a **useful frame** on the work. It is especially helpful when you need to objective usability benchmarking. The method is less helpful when there is no meaningful hypothesis yet or no decision will change based on the evidence.

## Canonical origin and what is “official” here

- **Origin / lineage:** Standard UX measurement practice.
- **Canonical status:** Canonical usability metric.
...
### Canonical structure
1. **Critical task** — Use this part to move the team from raw input toward a decision or artifact.
2. **Success criteria** — Use this part to move the team from raw input toward a decision or artifact.
3. **Observed attempts** — Use this part to move the team from raw input toward a decision or artifact.
4. **Completion rate** — Use this part to move the team from raw input toward a decision or artifact.
5. **Failure analysis** — Use this part to move the team from raw input toward a decision or artifact.

## When to use it

Use Task Completion Rate Test when:
...
**Practical caution:** This framework is strongest when used to objective usability benchmarking
...
- Usability measurement practice
- NN/g task success metrics
- PMFrame.works research workbook (uploaded source list)

## Bottom line

Task Completion Rate Test is most useful when you need a **disciplined lens** for a specific kind of product problem—not as a universal answer, but as a way to improve the quality of thinking, collaboration, and decision-making around that problem.
