...
language: "English"
confidence: "High"
canonical_status: "Canonical within PM interview practice."
---
...
CIRCLES Method helps by imposing a **useful frame** on the work. It is especially helpful when you need to interview-style product reasoning or rapid concept evaluation. The method is less helpful when the real problem is already well evidenced and the team simply needs execution discipline.

## Canonical origin and what is “official” here

- **Origin / lineage:** Created by Lewis Lin for product design interviews.
- **Canonical status:** Canonical within PM interview practice.
...
### Canonical structure
1. **Comprehend** — Use this part to move the team from raw input toward a decision or artifact.
2. **Identify customer** — Use this part to move the team from raw input toward a decision or artifact.
3. **Report needs** — Use this part to move the team from raw input toward a decision or artifact.
4. **Cut through prioritization** — Use this part to move the team from raw input toward a decision or artifact.
5. **List solutions** — Use this part to move the team from raw input toward a decision or artifact.
6. **Evaluate tradeoffs** — Use this part to move the team from raw input toward a decision or artifact.
7. **Summarize** — Use this part to move the team from raw input toward a decision or artifact.

## When to use it

Use CIRCLES Method when:
...
- **Primary fit:** interview-style product reasoning or rapid concept evaluation
- **Secondary fit:** situations where you need to align multiple people around the same lens before committing time or budget.
- **Good complement to:** Task Framing, Mental Models.
...
**Practical caution:** This framework is strongest when used to interview-style product reasoning or rapid concept evaluation
...
- Product design interview practice
- PMFrame.works research workbook (uploaded source list)

## Bottom line

CIRCLES Method is most useful when you need a **disciplined lens** for a specific kind of product problem—not as a universal answer, but as a way to improve the quality of thinking, collaboration, and decision-making around that problem.
