...
language: "English"
confidence: "High"
canonical_status: "Canonical strategic growth model."
---
...
Ansoff Matrix is a **growth** framework used to identify where demand, retention, messaging, or economics can improve compounding growth. In the uploaded PMFrame workbook, it is described as: **Frames growth through market penetration, market development, product development, and diversification. Best for strategic growth-option comparison.**. In practical product work, its value is that it gives teams a repeatable way to move from ambiguity to a clearer decision, artifact, or next experiment without pretending there is more certainty than the evidence actually supports.
...
Ansoff Matrix helps by imposing a **useful frame** on the work. It is especially helpful when you need to strategic growth-option comparison. The method is less helpful when the product still lacks a credible core value proposition or reliable retention signal.

## Canonical origin and what is “official” here

- **Origin / lineage:** Created by Igor Ansoff.
- **Canonical status:** Canonical strategic growth model.
...
### Canonical structure
1. **Market penetration** — Use this part to move the team from raw input toward a decision or artifact.
2. **Market development** — Use this part to move the team from raw input toward a decision or artifact.
3. **Product development** — Use this part to move the team from raw input toward a decision or artifact.
4. **Diversification** — Use this part to move the team from raw input toward a decision or artifact.

## When to use it

Use Ansoff Matrix when:
...
**Practical caution:** This framework is strongest when used to strategic growth-option comparison
...
Ansoff Matrix is most useful when you need a **disciplined lens** for a specific kind of product problem—not as a universal answer, but as a way to improve the quality of thinking, collaboration, and decision-making around that problem.
