...
language: "English"
confidence: "Moderate"
canonical_status: "Lean product artifact; variants exist."
---
...
Hypothesis Board helps by imposing a **useful frame** on the work. It is especially helpful when you need to making product bets legible and reviewable. The method is less helpful when there is no meaningful hypothesis yet or no decision will change based on the evidence.

## Canonical origin and what is “official” here

- **Origin / lineage:** Used in Lean UX and product discovery to make assumptions explicit.
- **Canonical status:** Lean product artifact; variants exist.
...
1. **Assumption** — Use this part to move the team from raw input toward a decision or artifact.
2. **Risk** — Use this part to move the team from raw input toward a decision or artifact.
3. **Experiment** — Use this part to move the team from raw input toward a decision or artifact.
4. **Evidence** — Use this part to move the team from raw input toward a decision or artifact.
5. **Decision** — Use this part to move the team from raw input toward a decision or artifact.

## When to use it

Use Hypothesis Board when:
...
**Practical caution:** This framework is strongest when used to making product bets legible and reviewable

## Related frameworks

- **Lean Startup MVP** — Adjacent method in the same PMFrame cluster.
- **A/B Testing** — Adjacent method in the same PMFrame cluster.
...
- Lean UX
- Discovery and experimentation practice
- PMFrame.works research workbook (uploaded source list)

## Bottom line

Hypothesis Board is most useful when you need a **disciplined lens** for a specific kind of product problem—not as a universal answer, but as a way to improve the quality of thinking, collaboration, and decision-making around that problem.
