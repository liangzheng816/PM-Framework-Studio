...
language: "English"
confidence: "High"
canonical_status: "Canonical startup growth funnel."
---
...
AARRR Pirates is a **growth** framework used to identify where demand, retention, messaging, or economics can improve compounding growth. In the uploaded PMFrame workbook, it is described as: **Breaks growth into acquisition, activation, retention, referral, and revenue. Best for finding where the funnel leaks.**. In practical product work, its value is that it gives teams a repeatable way to move from ambiguity to a clearer decision, artifact, or next experiment without pretending there is more certainty than the evidence actually supports.
...
AARRR Pirates helps by imposing a **useful frame** on the work. It is especially helpful when you need to finding where the funnel leaks. The method is less helpful when the product still lacks a credible core value proposition or reliable retention signal.

## Canonical origin and what is “official” here

- **Origin / lineage:** Created by Dave McClure.
- **Canonical status:** Canonical startup growth funnel.
...
### Canonical structure
1. **Acquisition** — Use this part to move the team from raw input toward a decision or artifact.
2. **Activation** — Use this part to move the team from raw input toward a decision or artifact.
3. **Retention** — Use this part to move the team from raw input toward a decision or artifact.
4. **Referral** — Use this part to move the team from raw input toward a decision or artifact.
5. **Revenue** — Use this part to move the team from raw input toward a decision or artifact.

## When to use it

Use AARRR Pirates when:
...
- **Primary fit:** finding where the funnel leaks
...
**Practical caution:** This framework is strongest when used to finding where the funnel leaks
...
AARRR Pirates is most useful when you need a **disciplined lens** for a specific kind of product problem—not as a universal answer, but as a way to improve the quality of thinking, collaboration, and decision-making around that problem.
