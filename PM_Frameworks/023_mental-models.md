...
language: "English"
confidence: "Moderate"
canonical_status: "Broad cognitive concept with many applications."
---
...
Mental Models is a **problem framing** framework used to separate the real problem from noise, symptoms, assumptions, and premature solution ideas. In the uploaded PMFrame workbook, it is described as: **Surfaces the assumptions users or teams already carry into a situation. Best for products where misconceptions or expectations shape behavior.**. In practical product work, its value is that it gives teams a repeatable way to move from ambiguity to a clearer decision, artifact, or next experiment without pretending there is more certainty than the evidence actually supports.
...
Mental Models helps by imposing a **useful frame** on the work. It is especially helpful when you need to products where misconceptions or expectations shape behavior. The method is less helpful when the real problem is already well evidenced and the team simply needs execution discipline.

## Canonical origin and what is “official” here

- **Origin / lineage:** Rooted in cognitive science and strategy; applied to UX and product strategy in multiple ways.
- **Canonical status:** Broad cognitive concept with many applications.
...
1. **Assumptions** — Use this part to move the team from raw input toward a decision or artifact.
2. **Causal beliefs** — Use this part to move the team from raw input toward a decision or artifact.
3. **Expectations** — Use this part to move the team from raw input toward a decision or artifact.
4. **Decision rules** — Use this part to move the team from raw input toward a decision or artifact.
5. **Mismatches with reality** — Use this part to move the team from raw input toward a decision or artifact.
...
- **Primary fit:** products where misconceptions or expectations shape behavior
- **Secondary fit:** situations where you need to align multiple people around the same lens before committing time or budget.
- **Good complement to:** Cynefin Framework, Task Framing.
...
**Practical caution:** This framework is strongest when used to products where misconceptions or expectations shape behavior

## Related frameworks

- **Cynefin Framework** — Adjacent method in the same PMFrame cluster.
- **Task Framing** — Adjacent method in the same PMFrame cluster.
- **CIRCLES Method** — Adjacent method in the same PMFrame cluster.
- **Working Backwards** — Adjacent method in the same PMFrame cluster.
...
Mental Models is most useful when you need a **disciplined lens** for a specific kind of product problem—not as a universal answer, but as a way to improve the quality of thinking, collaboration, and decision-making around that problem.
