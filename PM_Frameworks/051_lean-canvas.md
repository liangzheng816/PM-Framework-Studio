...
language: "English"
confidence: "High"
canonical_status: "Canonical startup canvas."
---
...
Lean Canvas is a **validation** framework used to reduce uncertainty by turning product beliefs into tests, metrics, and evidence-backed decisions. In the uploaded PMFrame workbook, it is described as: **Summarizes problem, solution, unfair advantage, channels, metrics, and economics on one page. Best for startup-style business-model validation.**. In practical product work, its value is that it gives teams a repeatable way to move from ambiguity to a clearer decision, artifact, or next experiment without pretending there is more certainty than the evidence actually supports.
...
Lean Canvas helps by imposing a **useful frame** on the work. It is especially helpful when you need to startup-style business-model validation. The method is less helpful when there is no meaningful hypothesis yet or no decision will change based on the evidence.

## Canonical origin and what is “official” here

- **Origin / lineage:** Created by Ash Maurya as an adaptation of the Business Model Canvas.
- **Canonical status:** Canonical startup canvas.
...
### Canonical structure
1. **Problem** — Use this part to move the team from raw input toward a decision or artifact.
2. **Customer segments** — Use this part to move the team from raw input toward a decision or artifact.
3. **Unique value proposition** — Use this part to move the team from raw input toward a decision or artifact.
4. **Solution** — Use this part to move the team from raw input toward a decision or artifact.
5. **Channels** — Use this part to move the team from raw input toward a decision or artifact.
6. **Revenue** — Use this part to move the team from raw input toward a decision or artifact.
7. **Costs** — Use this part to move the team from raw input toward a decision or artifact.
8. **Key metrics** — Use this part to move the team from raw input toward a decision or artifact.
9. **Unfair advantage** — Use this part to move the team from raw input toward a decision or artifact.
...
**Practical caution:** This framework is strongest when used to startup-style business-model validation

## Related frameworks

- **North Star Metric** — Adjacent method in the same PMFrame cluster.
- **Validation Learning Loop** — Adjacent method in the same PMFrame cluster.
- **Problem-Solution Fit** — Adjacent method in the same PMFrame cluster.
- **Task Completion Rate Test** — Adjacent method in the same PMFrame cluster.
...
Lean Canvas is most useful when you need a **disciplined lens** for a specific kind of product problem—not as a universal answer, but as a way to improve the quality of thinking, collaboration, and decision-making around that problem.
