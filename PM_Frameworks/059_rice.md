...
language: "English"
confidence: "High"
canonical_status: "Canonical modern prioritization formula."
---
...
RICE is a **execution** framework used to translate intent into scope, sequence, ownership, and repeatable delivery decisions. In the uploaded PMFrame workbook, it is described as: **Scores work by reach, impact, confidence, and effort. Best for defensible prioritization under resource pressure.**. In practical product work, its value is that it gives teams a repeatable way to move from ambiguity to a clearer decision, artifact, or next experiment without pretending there is more certainty than the evidence actually supports.
...
RICE helps by imposing a **useful frame** on the work. It is especially helpful when you need to defensible prioritization under resource pressure. The method is less helpful when the team is still unclear about the user problem or the evidence base behind the work.

## Canonical origin and what is “official” here

- **Origin / lineage:** Popularized by Intercom.
- **Canonical status:** Canonical modern prioritization formula.
...
### Canonical structure
1. **Reach** — Use this part to move the team from raw input toward a decision or artifact.
2. **Impact** — Use this part to move the team from raw input toward a decision or artifact.
3. **Confidence** — Use this part to move the team from raw input toward a decision or artifact.
4. **Effort** — Use this part to move the team from raw input toward a decision or artifact.
...
**Practical caution:** RICE is most valuable when the inputs are estimated consistently and transparently enough to compare work, not to simulate certainty.

## Related frameworks

- **User Story Map** — Adjacent method in the same PMFrame cluster.
...
- Intercom on RICE
- Product prioritization practice
- PMFrame.works research workbook (uploaded source list)

## Bottom line

RICE is most useful when you need a **disciplined lens** for a specific kind of product problem—not as a universal answer, but as a way to improve the quality of thinking, collaboration, and decision-making around that problem.
