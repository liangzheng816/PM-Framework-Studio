---
title: "Musk’s Five-Step Method"
category: "Problem framing"
pmframe_order: 013
language: "English"
confidence: "Moderate"
canonical_status: "Practitioner framework explicitly articulated by Elon Musk; not an academic framework."
---
...
Musk’s Five-Step Method is a **problem framing** framework used to separate the real problem from noise, symptoms, assumptions, and premature solution ideas. In the uploaded PMFrame workbook, it is described as: **Operational first-principles-style simplification: challenge requirements, delete parts, simplify, accelerate, automate. Best for overbuilt processes or products with legacy complexity.**. In practical product work, its value is that it gives teams a repeatable way to move from ambiguity to a clearer decision, artifact, or next experiment without pretending there is more certainty than the evidence actually supports.
...
Musk’s Five-Step Method helps by imposing a **useful frame** on the work. It is especially helpful when you need to overbuilt processes or products with legacy complexity. The method is less helpful when the real problem is already well evidenced and the team simply needs execution discipline.

## Canonical origin and what is “official” here

- **Origin / lineage:** Derived from SpaceX and Tesla engineering practice and public talks by Elon Musk.
- **Canonical status:** Practitioner framework explicitly articulated by Elon Musk; not an academic framework.
...
1. **Question requirements** — Use this part to move the team from raw input toward a decision or artifact.
2. **Delete** — Use this part to move the team from raw input toward a decision or artifact.
3. **Simplify and optimize** — Use this part to move the team from raw input toward a decision or artifact.
4. **Accelerate cycle time** — Use this part to move the team from raw input toward a decision or artifact.
5. **Automate last** — Use this part to move the team from raw input toward a decision or artifact.

## When to use it

Use Musk’s Five-Step Method when:
...
### Typical outputs
- clear problem statement, root-cause hypothesis, decision frame, or strategic lens
...
**Practical caution:** The discipline comes from respecting the order; skipping straight to automation destroys most of the value.

## Related frameworks

- **5 Whys** — Adjacent method in the same PMFrame cluster.
- **HMW Problem Frame** — Adjacent method in the same PMFrame cluster.

## References and authority trail

The note was grounded in the following authority sources or canonical references:
- Elon Musk interviews / factory talks
- PMFrame Musk page
- PMFrame.works research workbook (uploaded source list)

## Bottom line

Musk’s Five-Step Method is most useful when you need a **disciplined lens** for a specific kind of product problem—not as a universal answer, but as a way to improve the quality of thinking, collaboration, and decision-making around that problem.
