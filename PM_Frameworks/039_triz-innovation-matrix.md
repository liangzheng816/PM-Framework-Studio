---
title: "TRIZ Innovation Matrix"
category: "Ideation"
pmframe_order: 039
language: "English"
confidence: "High"
canonical_status: "Canonical inventive problem-solving method."
---
...
TRIZ Innovation Matrix is a **ideation** framework used to expand the option space before the team commits too early to one direction. In the uploaded PMFrame workbook, it is described as: **Uses contradiction patterns and solution principles from patent analysis to solve hard tradeoffs. Best for engineering-heavy or constraint-rich innovation.**. In practical product work, its value is that it gives teams a repeatable way to move from ambiguity to a clearer decision, artifact, or next experiment without pretending there is more certainty than the evidence actually supports.
...
TRIZ Innovation Matrix helps by imposing a **useful frame** on the work. It is especially helpful when you need to engineering-heavy or constraint-rich innovation. The method is less helpful when the main uncertainty is no longer idea quality but evidence, feasibility, or delivery.

## Canonical origin and what is “official” here

- **Origin / lineage:** Created by Genrich Altshuller from patent pattern analysis.
- **Canonical status:** Canonical inventive problem-solving method.
...
### Canonical structure
1. **Engineering contradiction** — Use this part to move the team from raw input toward a decision or artifact.
2. **Parameters** — Use this part to move the team from raw input toward a decision or artifact.
3. **Inventive principles** — Use this part to move the team from raw input toward a decision or artifact.
4. **Matrix lookup** — Use this part to move the team from raw input toward a decision or artifact.
5. **Adapted solution** — Use this part to move the team from raw input toward a decision or artifact.

## When to use it

Use TRIZ Innovation Matrix when:
...
**Practical caution:** This framework is strongest when used to engineering-heavy or constraint-rich innovation

## Related frameworks

- **Opportunity Solution Tree** — Adjacent method in the same PMFrame cluster.
- **Story Spine** — Adjacent method in the same PMFrame cluster.
- **Pain-Solution Matrix** — Adjacent method in the same PMFrame cluster.
- **Morphological Analysis** — Adjacent method in the same PMFrame cluster.
...
TRIZ Innovation Matrix is most useful when you need a **disciplined lens** for a specific kind of product problem—not as a universal answer, but as a way to improve the quality of thinking, collaboration, and decision-making around that problem.
