---
title: "Validation Learning Loop"
category: "Validation"
pmframe_order: 050
language: "English"
confidence: "High"
canonical_status: "Canonical lean-learning pattern in spirit; names vary."
---
...
Validation Learning Loop helps by imposing a **useful frame** on the work. It is especially helpful when you need to disciplined discovery rather than ad hoc experimentation. The method is less helpful when there is no meaningful hypothesis yet or no decision will change based on the evidence.

## Canonical origin and what is “official” here

- **Origin / lineage:** Built from lean startup build-measure-learn logic.
- **Canonical status:** Canonical lean-learning pattern in spirit; names vary.
...
### Canonical structure
1. **Hypothesis** — Use this part to move the team from raw input toward a decision or artifact.
2. **Build / test** — Use this part to move the team from raw input toward a decision or artifact.
3. **Measure** — Use this part to move the team from raw input toward a decision or artifact.
4. **Learn** — Use this part to move the team from raw input toward a decision or artifact.
5. **Persevere / pivot** — Use this part to move the team from raw input toward a decision or artifact.

## When to use it

Use Validation Learning Loop when:
...
- **Primary fit:** disciplined discovery rather than ad hoc experimentation
- **Secondary fit:** situations where you need to align multiple people around the same lens before committing time or budget.
- **Good complement to:** Wizard of Oz Test, North Star Metric.
...
**Practical caution:** This framework is strongest when used to disciplined discovery rather than ad hoc experimentation
...
- Discovery learning loops
- PMFrame.works research workbook (uploaded source list)

## Bottom line

Validation Learning Loop is most useful when you need a **disciplined lens** for a specific kind of product problem—not as a universal answer, but as a way to improve the quality of thinking, collaboration, and decision-making around that problem.
