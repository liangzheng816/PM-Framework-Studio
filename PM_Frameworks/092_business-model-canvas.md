...
language: "English"
confidence: "High"
canonical_status: "Canonical strategy canvas."
---
...
Business Model Canvas is a **systems thinking** framework used to understand the broader structure around the product, including dependencies, incentives, constraints, and feedback loops. In the uploaded PMFrame workbook, it is described as: **Summarizes customer, value, channel, revenue, cost, and key-resource logic on one page. Best for business-model clarity and comparison.**. In practical product work, its value is that it gives teams a repeatable way to move from ambiguity to a clearer decision, artifact, or next experiment without pretending there is more certainty than the evidence actually supports.
...
Business Model Canvas helps by imposing a **useful frame** on the work. It is especially helpful when you need to business-model clarity and comparison. The method is less helpful when the question is narrow, tactical, and does not require a system-level view.

## Canonical origin and what is “official” here

- **Origin / lineage:** Created by Alexander Osterwalder and Yves Pigneur.
- **Canonical status:** Canonical strategy canvas.
...
### Canonical structure
1. **Customer segments** — Use this part to move the team from raw input toward a decision or artifact.
2. **Value propositions** — Use this part to move the team from raw input toward a decision or artifact.
3. **Channels** — Use this part to move the team from raw input toward a decision or artifact.
4. **Customer relationships** — Use this part to move the team from raw input toward a decision or artifact.
5. **Revenue streams** — Use this part to move the team from raw input toward a decision or artifact.
6. **Key resources** — Use this part to move the team from raw input toward a decision or artifact.
7. **Key activities** — Use this part to move the team from raw input toward a decision or artifact.
8. **Key partners** — Use this part to move the team from raw input toward a decision or artifact.
9. **Cost structure** — Use this part to move the team from raw input toward a decision or artifact.
...
**Practical caution:** This framework is strongest when used to business-model clarity and comparison

## Related frameworks

- **Three Horizons** — Adjacent method in the same PMFrame cluster.
- **Platform Ecosystem Canvas** — Adjacent method in the same PMFrame cluster.
- **Product Lifecycle Management** — Adjacent method in the same PMFrame cluster.
- **Antifragile Design** — Adjacent method in the same PMFrame cluster.
...
Business Model Canvas is most useful when you need a **disciplined lens** for a specific kind of product problem—not as a universal answer, but as a way to improve the quality of thinking, collaboration, and decision-making around that problem.
