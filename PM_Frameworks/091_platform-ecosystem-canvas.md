---
title: "Platform Ecosystem Canvas"
category: "Systems thinking"
pmframe_order: 091
language: "English"
confidence: "Moderate"
canonical_status: "Practitioner ecosystem-design canvas; variants exist."
---
...
Platform Ecosystem Canvas helps by imposing a **useful frame** on the work. It is especially helpful when you need to marketplace or ecosystem design. The method is less helpful when the question is narrow, tactical, and does not require a system-level view.

## Canonical origin and what is “official” here

- **Origin / lineage:** A canvas used to model actors, exchanges, incentives, and governance in multi-sided systems.
- **Canonical status:** Practitioner ecosystem-design canvas; variants exist.
...
1. **Participants** — Use this part to move the team from raw input toward a decision or artifact.
2. **Value exchange** — Use this part to move the team from raw input toward a decision or artifact.
3. **Incentives** — Use this part to move the team from raw input toward a decision or artifact.
4. **Rules / governance** — Use this part to move the team from raw input toward a decision or artifact.
5. **Health metrics** — Use this part to move the team from raw input toward a decision or artifact.

## When to use it

Use Platform Ecosystem Canvas when:
...
- **Primary fit:** marketplace or ecosystem design
...
**Practical caution:** This framework is strongest when used to marketplace or ecosystem design
...
- Ecosystem canvas methods
- PMFrame.works research workbook (uploaded source list)

## Bottom line

Platform Ecosystem Canvas is most useful when you need a **disciplined lens** for a specific kind of product problem—not as a universal answer, but as a way to improve the quality of thinking, collaboration, and decision-making around that problem.
