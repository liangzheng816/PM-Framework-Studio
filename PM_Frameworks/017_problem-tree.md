...
language: "English"
confidence: "Moderate"
canonical_status: "Established problem-analysis tool in policy, nonprofit, and development work."
---
...
Problem Tree is a **problem framing** framework used to separate the real problem from noise, symptoms, assumptions, and premature solution ideas. In the uploaded PMFrame workbook, it is described as: **Breaks a problem into causes, sub-causes, and effects. Best when stakeholders keep mixing root causes with downstream symptoms.**. In practical product work, its value is that it gives teams a repeatable way to move from ambiguity to a clearer decision, artifact, or next experiment without pretending there is more certainty than the evidence actually supports.
...
Problem Tree helps by imposing a **useful frame** on the work. It is especially helpful when you need to messy requests, recurring issues, strategic ambiguity, and stakeholder disagreement about what to solve. The method is less helpful when the real problem is already well evidenced and the team simply needs execution discipline.

## Canonical origin and what is “official” here

- **Origin / lineage:** Used in logical framework and problem-analysis methods.
- **Canonical status:** Established problem-analysis tool in policy, nonprofit, and development work.
...
1. **Core problem** — Use this part to move the team from raw input toward a decision or artifact.
2. **Root causes** — Use this part to move the team from raw input toward a decision or artifact.
3. **Sub-causes** — Use this part to move the team from raw input toward a decision or artifact.
4. **Effects** — Use this part to move the team from raw input toward a decision or artifact.
5. **Priorities** — Use this part to move the team from raw input toward a decision or artifact.

## When to use it

Use Problem Tree when:
...
- **Good complement to:** HMW Problem Frame, POV Statement.
...
- Problem tree analysis guidance
- Logical framework methods
- PMFrame.works research workbook (uploaded source list)

## Bottom line

Problem Tree is most useful when you need a **disciplined lens** for a specific kind of product problem—not as a universal answer, but as a way to improve the quality of thinking, collaboration, and decision-making around that problem.
