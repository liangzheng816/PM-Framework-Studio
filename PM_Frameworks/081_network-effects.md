...
language: "English"
confidence: "High"
canonical_status: "Canonical platform strategy concept."
---
...
Network Effects helps by imposing a **useful frame** on the work. It is especially helpful when you need to marketplace, platform, and social products. The method is less helpful when the product still lacks a credible core value proposition or reliable retention signal.

## Canonical origin and what is “official” here

- **Origin / lineage:** Economic and platform-strategy literature.
- **Canonical status:** Canonical platform strategy concept.
...
### Canonical structure
1. **Direct effects** — Use this part to move the team from raw input toward a decision or artifact.
2. **Indirect effects** — Use this part to move the team from raw input toward a decision or artifact.
3. **Cross-side effects** — Use this part to move the team from raw input toward a decision or artifact.
4. **Liquidity / density** — Use this part to move the team from raw input toward a decision or artifact.
5. **Defensibility** — Use this part to move the team from raw input toward a decision or artifact.

## When to use it

Use Network Effects when:
...
**Practical caution:** Many teams claim network effects too early; the key question is whether each added participant makes the product better for others.
...
- NFX / platform strategy concepts
- PMFrame.works research workbook (uploaded source list)

## Bottom line

Network Effects is most useful when you need a **disciplined lens** for a specific kind of product problem—not as a universal answer, but as a way to improve the quality of thinking, collaboration, and decision-making around that problem.
