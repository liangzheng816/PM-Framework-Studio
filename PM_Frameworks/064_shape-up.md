...
language: "English"
confidence: "High"
canonical_status: "Canonical within Basecamp’s delivery model."
---
...
Shape Up helps by imposing a **useful frame** on the work. It is especially helpful when you need to product teams that want fewer endless backlogs and more bounded bets. The method is less helpful when the team is still unclear about the user problem or the evidence base behind the work.

## Canonical origin and what is “official” here

- **Origin / lineage:** Created by Basecamp and documented by Ryan Singer.
- **Canonical status:** Canonical within Basecamp’s delivery model.
...
### Canonical structure
1. **Shaping** — Use this part to move the team from raw input toward a decision or artifact.
2. **Betting table** — Use this part to move the team from raw input toward a decision or artifact.
3. **Six-week cycles** — Use this part to move the team from raw input toward a decision or artifact.
4. **Cooldown** — Use this part to move the team from raw input toward a decision or artifact.
5. **Hill charts** — Use this part to move the team from raw input toward a decision or artifact.
...
- **Primary fit:** product teams that want fewer endless backlogs and more bounded bets
- **Secondary fit:** situations where you need to align multiple people around the same lens before committing time or budget.
- **Good complement to:** Sprint Framework, Google Design Sprint.
...
**Practical caution:** Shape Up changes more than planning; it changes how teams think about appetite, shaping, and fixed-time execution.
...
- Basecamp product process
- PMFrame.works research workbook (uploaded source list)

## Bottom line

Shape Up is most useful when you need a **disciplined lens** for a specific kind of product problem—not as a universal answer, but as a way to improve the quality of thinking, collaboration, and decision-making around that problem.
