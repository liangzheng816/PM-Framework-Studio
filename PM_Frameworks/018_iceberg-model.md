...
language: "English"
confidence: "Moderate"
canonical_status: "Established systems-thinking lens."
---
...
Iceberg Model is a **problem framing** framework used to separate the real problem from noise, symptoms, assumptions, and premature solution ideas. In the uploaded PMFrame workbook, it is described as: **Looks below visible events to patterns, structures, and mental models. Best for recurring organizational or market problems that keep resurfacing.**. In practical product work, its value is that it gives teams a repeatable way to move from ambiguity to a clearer decision, artifact, or next experiment without pretending there is more certainty than the evidence actually supports.
...
Iceberg Model helps by imposing a **useful frame** on the work. It is especially helpful when you need to recurring organizational or market problems that keep resurfacing. The method is less helpful when the real problem is already well evidenced and the team simply needs execution discipline.

## Canonical origin and what is “official” here

- **Origin / lineage:** Common systems-thinking teaching model used by Senge-inspired practitioners.
- **Canonical status:** Established systems-thinking lens.
...
1. **Events** — Use this part to move the team from raw input toward a decision or artifact.
2. **Patterns / trends** — Use this part to move the team from raw input toward a decision or artifact.
3. **System structures** — Use this part to move the team from raw input toward a decision or artifact.
4. **Mental models** — Use this part to move the team from raw input toward a decision or artifact.

## When to use it

Use Iceberg Model when:
...
- **Primary fit:** recurring organizational or market problems that keep resurfacing
- **Secondary fit:** situations where you need to align multiple people around the same lens before committing time or budget.
- **Good complement to:** POV Statement, Problem Tree.
...
**Practical caution:** This framework is strongest when used to recurring organizational or market problems that keep resurfacing
...
- Waters Center systems thinking
- PMFrame.works research workbook (uploaded source list)

## Bottom line

Iceberg Model is most useful when you need a **disciplined lens** for a specific kind of product problem—not as a universal answer, but as a way to improve the quality of thinking, collaboration, and decision-making around that problem.
