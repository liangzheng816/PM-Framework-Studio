...
language: "English"
confidence: "High"
canonical_status: "Canonical product and UX artifact when grounded in research."
---
...
Persona helps by imposing a **useful frame** on the work. It is especially helpful when you need to aligning teams on who the product is really for. The method is less helpful when the team already needs a hard delivery plan or the main bottleneck is implementation rather than understanding.

## Canonical origin and what is “official” here

- **Origin / lineage:** Popularized in interaction design by Alan Cooper; widely used in UX research.
- **Canonical status:** Canonical product and UX artifact when grounded in research.
...
### Canonical structure
1. **Goals** — Use this part to move the team from raw input toward a decision or artifact.
2. **Behaviors** — Use this part to move the team from raw input toward a decision or artifact.
3. **Context** — Use this part to move the team from raw input toward a decision or artifact.
4. **Pain points** — Use this part to move the team from raw input toward a decision or artifact.
5. **Motivations** — Use this part to move the team from raw input toward a decision or artifact.
6. **Constraints** — Use this part to move the team from raw input toward a decision or artifact.
...
**Practical caution:** This framework is strongest when used to aligning teams on who the product is really for
...
Persona is most useful when you need a **disciplined lens** for a specific kind of product problem—not as a universal answer, but as a way to improve the quality of thinking, collaboration, and decision-making around that problem.
