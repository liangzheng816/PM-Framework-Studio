...
language: "English"
confidence: "Moderate"
canonical_status: "Established ideation variant; no single owner."
---
...
Reverse Brainstorming helps by imposing a **useful frame** on the work. It is especially helpful when you need to surfacing hidden risks and blind spots. The method is less helpful when the main uncertainty is no longer idea quality but evidence, feasibility, or delivery.

## Canonical origin and what is “official” here

- **Origin / lineage:** A facilitation technique that inverts the problem to surface risk and opportunity.
- **Canonical status:** Established ideation variant; no single owner.
...
1. **State desired outcome** — Use this part to move the team from raw input toward a decision or artifact.
2. **Invert the question** — Use this part to move the team from raw input toward a decision or artifact.
3. **Generate failure ideas** — Use this part to move the team from raw input toward a decision or artifact.
4. **Cluster causes** — Use this part to move the team from raw input toward a decision or artifact.
5. **Invert into improvements** — Use this part to move the team from raw input toward a decision or artifact.
...
**Practical caution:** This framework is strongest when used to surfacing hidden risks and blind spots

## Related frameworks

- **SCAMPER** — Adjacent method in the same PMFrame cluster.
- **Six Thinking Hats** — Adjacent method in the same PMFrame cluster.
...
- Facilitation and ideation practice
- Miro / Mural reverse brainstorming guidance
- PMFrame.works research workbook (uploaded source list)

## Bottom line

Reverse Brainstorming is most useful when you need a **disciplined lens** for a specific kind of product problem—not as a universal answer, but as a way to improve the quality of thinking, collaboration, and decision-making around that problem.
