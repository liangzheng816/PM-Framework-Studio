---
title: "Feature Priority Pyramid"
category: "Execution"
pmframe_order: 070
language: "English"
confidence: "Moderate"
canonical_status: "Practitioner prioritization visual; no single canonical source."
---
...
Feature Priority Pyramid is a **execution** framework used to translate intent into scope, sequence, ownership, and repeatable delivery decisions. In the uploaded PMFrame workbook, it is described as: **Layers foundational, performance, and differentiating capabilities so roadmaps don’t overinvest in shiny top-layer features too soon. Best for staged roadmap design.**. In practical product work, its value is that it gives teams a repeatable way to move from ambiguity to a clearer decision, artifact, or next experiment without pretending there is more certainty than the evidence actually supports.
...
Feature Priority Pyramid helps by imposing a **useful frame** on the work. It is especially helpful when you need to staged roadmap design. The method is less helpful when the team is still unclear about the user problem or the evidence base behind the work.

## Canonical origin and what is “official” here

- **Origin / lineage:** A layered way to separate foundational, performance, and differentiating features.
- **Canonical status:** Practitioner prioritization visual; no single canonical source.
...
1. **Foundation** — Use this part to move the team from raw input toward a decision or artifact.
2. **Performance** — Use this part to move the team from raw input toward a decision or artifact.
3. **Differentiation** — Use this part to move the team from raw input toward a decision or artifact.

## When to use it

Use Feature Priority Pyramid when:
...
**Practical caution:** This framework is strongest when used to staged roadmap design

## Related frameworks

- **OGSM** — Adjacent method in the same PMFrame cluster.
- **SNAP Decision Framework** — Adjacent method in the same PMFrame cluster.
- **Requirements Priority Quadrants** — Adjacent method in the same PMFrame cluster.
- **User Feedback Loop** — Adjacent method in the same PMFrame cluster.

## References and authority trail

The note was grounded in the following authority sources or canonical references:
- Feature strategy practice
- Prioritization by user value
- PMFrame.works research workbook (uploaded source list)

## Bottom line

Feature Priority Pyramid is most useful when you need a **disciplined lens** for a specific kind of product problem—not as a universal answer, but as a way to improve the quality of thinking, collaboration, and decision-making around that problem.
