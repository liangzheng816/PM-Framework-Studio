...
language: "English"
confidence: "High"
canonical_status: "Canonical sense-making framework."
---
...
Cynefin Framework is a **problem framing** framework used to separate the real problem from noise, symptoms, assumptions, and premature solution ideas. In the uploaded PMFrame workbook, it is described as: **Sorts situations into clear, complicated, complex, chaotic, and disorder so teams use the right decision mode. Best when people disagree because the problem type itself is unclear.**. In practical product work, its value is that it gives teams a repeatable way to move from ambiguity to a clearer decision, artifact, or next experiment without pretending there is more certainty than the evidence actually supports.
...
Cynefin Framework helps by imposing a **useful frame** on the work. It is especially helpful when you need to messy requests, recurring issues, strategic ambiguity, and stakeholder disagreement about what to solve. The method is less helpful when the real problem is already well evidenced and the team simply needs execution discipline.

## Canonical origin and what is “official” here

- **Origin / lineage:** Created by Dave Snowden.
- **Canonical status:** Canonical sense-making framework.
...
### Canonical structure
1. **Clear** — Use this part to move the team from raw input toward a decision or artifact.
2. **Complicated** — Use this part to move the team from raw input toward a decision or artifact.
3. **Complex** — Use this part to move the team from raw input toward a decision or artifact.
4. **Chaotic** — Use this part to move the team from raw input toward a decision or artifact.
5. **Disorder** — Use this part to move the team from raw input toward a decision or artifact.

## When to use it

Use Cynefin Framework when:
...
- **Primary fit:** messy requests, recurring issues, strategic ambiguity, and stakeholder disagreement about what to solve
- **Secondary fit:** situations where you need to align multiple people around the same lens before committing time or budget.
- **Good complement to:** Double Diamond, Root Cause Analysis.
...
**Practical caution:** The point is not labeling for its own sake; it is choosing the right decision mode for the kind of reality you are facing.

## Related frameworks

- **Double Diamond** — Adjacent method in the same PMFrame cluster.
- **Root Cause Analysis** — Adjacent method in the same PMFrame cluster.
- **Task Framing** — Adjacent method in the same PMFrame cluster.
- **Mental Models** — Adjacent method in the same PMFrame cluster.

## References and authority trail

The note was grounded in the following authority sources or canonical references:
- Cynefin Center
- Dave Snowden writings
- PMFrame.works research workbook (uploaded source list)

## Bottom line

Cynefin Framework is most useful when you need a **disciplined lens** for a specific kind of product problem—not as a universal answer, but as a way to improve the quality of thinking, collaboration, and decision-making around that problem.
