---
title: "Pain-Solution Matrix"
category: "Ideation"
pmframe_order: 040
language: "English"
confidence: "Moderate"
canonical_status: "Practitioner concept-selection tool."
---
...
Pain-Solution Matrix is a **ideation** framework used to expand the option space before the team commits too early to one direction. In the uploaded PMFrame workbook, it is described as: **Maps painful user problems against candidate solutions to find the strongest problem-solution pairs. Best for early concept selection.**. In practical product work, its value is that it gives teams a repeatable way to move from ambiguity to a clearer decision, artifact, or next experiment without pretending there is more certainty than the evidence actually supports.
...
Pain-Solution Matrix helps by imposing a **useful frame** on the work. It is especially helpful when you need to early concept selection. The method is less helpful when the main uncertainty is no longer idea quality but evidence, feasibility, or delivery.

## Canonical origin and what is “official” here

- **Origin / lineage:** A practical matrix for matching painful problems to candidate solutions.
- **Canonical status:** Practitioner concept-selection tool.
...
1. **Pain severity** — Use this part to move the team from raw input toward a decision or artifact.
2. **Frequency** — Use this part to move the team from raw input toward a decision or artifact.
3. **Current workaround** — Use this part to move the team from raw input toward a decision or artifact.
4. **Candidate solution** — Use this part to move the team from raw input toward a decision or artifact.
5. **Value / feasibility** — Use this part to move the team from raw input toward a decision or artifact.

## When to use it

Use Pain-Solution Matrix when:
...
**Practical caution:** This framework is strongest when used to early concept selection
...
- Lean product discovery practice
- Problem-solution mapping methods
- PMFrame.works research workbook (uploaded source list)

## Bottom line

Pain-Solution Matrix is most useful when you need a **disciplined lens** for a specific kind of product problem—not as a universal answer, but as a way to improve the quality of thinking, collaboration, and decision-making around that problem.
