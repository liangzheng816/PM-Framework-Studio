...
language: "English"
confidence: "Moderate"
canonical_status: "Established creativity principle rather than one rigid framework."
---
...
Analogical Thinking helps by imposing a **useful frame** on the work. It is especially helpful when you need to getting beyond same-industry clichés. The method is less helpful when the main uncertainty is no longer idea quality but evidence, feasibility, or delivery.

## Canonical origin and what is “official” here

- **Origin / lineage:** Draws from design, strategy, and cognitive science on analogies.
- **Canonical status:** Established creativity principle rather than one rigid framework.
...
1. **Target problem** — Use this part to move the team from raw input toward a decision or artifact.
2. **Source domain** — Use this part to move the team from raw input toward a decision or artifact.
3. **Shared structure** — Use this part to move the team from raw input toward a decision or artifact.
4. **Transferred principle** — Use this part to move the team from raw input toward a decision or artifact.
5. **Adapted concept** — Use this part to move the team from raw input toward a decision or artifact.

## When to use it

Use Analogical Thinking when:
...
**Practical caution:** This framework is strongest when used to getting beyond same-industry clichés

## Related frameworks

- **Reverse Brainstorming** — Adjacent method in the same PMFrame cluster.
...
- Innovation by analogy literature
- Design strategy practice
- PMFrame.works research workbook (uploaded source list)

## Bottom line

Analogical Thinking is most useful when you need a **disciplined lens** for a specific kind of product problem—not as a universal answer, but as a way to improve the quality of thinking, collaboration, and decision-making around that problem.
