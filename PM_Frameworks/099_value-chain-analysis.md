...
language: "English"
confidence: "High"
canonical_status: "Canonical strategic analysis tool."
---
...
Value Chain Analysis helps by imposing a **useful frame** on the work. It is especially helpful when you need to cost, strategy, and moat analysis. The method is less helpful when the question is narrow, tactical, and does not require a system-level view.

## Canonical origin and what is “official” here

- **Origin / lineage:** Created by Michael Porter.
- **Canonical status:** Canonical strategic analysis tool.
...
### Canonical structure
1. **Primary activities** — Use this part to move the team from raw input toward a decision or artifact.
2. **Support activities** — Use this part to move the team from raw input toward a decision or artifact.
3. **Cost drivers** — Use this part to move the team from raw input toward a decision or artifact.
4. **Differentiation drivers** — Use this part to move the team from raw input toward a decision or artifact.
5. **Improvement priorities** — Use this part to move the team from raw input toward a decision or artifact.
...
**Practical caution:** This framework is strongest when used to cost, strategy, and moat analysis
...
Value Chain Analysis is most useful when you need a **disciplined lens** for a specific kind of product problem—not as a universal answer, but as a way to improve the quality of thinking, collaboration, and decision-making around that problem.
