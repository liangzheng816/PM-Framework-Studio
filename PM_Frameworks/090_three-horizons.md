...
language: "English"
confidence: "High"
canonical_status: "Canonical innovation portfolio model."
---
...
Three Horizons is a **systems thinking** framework used to understand the broader structure around the product, including dependencies, incentives, constraints, and feedback loops. In the uploaded PMFrame workbook, it is described as: **Balances today’s core business, medium-term growth engines, and long-term bets. Best for portfolio and innovation planning.**. In practical product work, its value is that it gives teams a repeatable way to move from ambiguity to a clearer decision, artifact, or next experiment without pretending there is more certainty than the evidence actually supports.
...
Three Horizons helps by imposing a **useful frame** on the work. It is especially helpful when you need to portfolio and innovation planning. The method is less helpful when the question is narrow, tactical, and does not require a system-level view.

## Canonical origin and what is “official” here

- **Origin / lineage:** Popularized by McKinsey and horizon-based innovation planning.
- **Canonical status:** Canonical innovation portfolio model.
...
### Canonical structure
1. **Horizon 1** — Use this part to move the team from raw input toward a decision or artifact.
2. **Horizon 2** — Use this part to move the team from raw input toward a decision or artifact.
3. **Horizon 3** — Use this part to move the team from raw input toward a decision or artifact.

## When to use it

Use Three Horizons when:
...
**Practical caution:** This framework is strongest when used to portfolio and innovation planning
...
- Three Horizons literature
- Portfolio innovation planning
- PMFrame.works research workbook (uploaded source list)

## Bottom line

Three Horizons is most useful when you need a **disciplined lens** for a specific kind of product problem—not as a universal answer, but as a way to improve the quality of thinking, collaboration, and decision-making around that problem.
