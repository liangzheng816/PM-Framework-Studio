...
language: "English"
confidence: "High"
canonical_status: "Canonical prioritization framework."
---
...
MoSCoW helps by imposing a **useful frame** on the work. It is especially helpful when you need to fast alignment on release boundaries. The method is less helpful when the team is still unclear about the user problem or the evidence base behind the work.

## Canonical origin and what is “official” here

- **Origin / lineage:** Associated with DSDM / Agile project delivery.
- **Canonical status:** Canonical prioritization framework.
...
### Canonical structure
1. **Must** — Use this part to move the team from raw input toward a decision or artifact.
2. **Should** — Use this part to move the team from raw input toward a decision or artifact.
3. **Could** — Use this part to move the team from raw input toward a decision or artifact.
4. **Won't** — Use this part to move the team from raw input toward a decision or artifact.
...
**Practical caution:** This framework is strongest when used to fast alignment on release boundaries
...
MoSCoW is most useful when you need a **disciplined lens** for a specific kind of product problem—not as a universal answer, but as a way to improve the quality of thinking, collaboration, and decision-making around that problem.
