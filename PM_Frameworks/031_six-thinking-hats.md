...
language: "English"
confidence: "High"
canonical_status: "Canonical lateral-thinking method."
---
...
Six Thinking Hats helps by imposing a **useful frame** on the work. It is especially helpful when you need to meetings that otherwise devolve into mixed-mode arguing. The method is less helpful when the main uncertainty is no longer idea quality but evidence, feasibility, or delivery.

## Canonical origin and what is “official” here

- **Origin / lineage:** Created by Edward de Bono.
- **Canonical status:** Canonical lateral-thinking method.
...
### Canonical structure
1. **White** — Use this part to move the team from raw input toward a decision or artifact.
2. **Red** — Use this part to move the team from raw input toward a decision or artifact.
3. **Black** — Use this part to move the team from raw input toward a decision or artifact.
4. **Yellow** — Use this part to move the team from raw input toward a decision or artifact.
5. **Green** — Use this part to move the team from raw input toward a decision or artifact.
6. **Blue** — Use this part to move the team from raw input toward a decision or artifact.
...
**Practical caution:** This framework is strongest when used to meetings that otherwise devolve into mixed-mode arguing
...
Six Thinking Hats is most useful when you need a **disciplined lens** for a specific kind of product problem—not as a universal answer, but as a way to improve the quality of thinking, collaboration, and decision-making around that problem.
